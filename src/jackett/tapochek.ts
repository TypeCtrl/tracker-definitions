  ...
  caps: {
    categorymappings: [
      ...
      { id: '203', cat: 'PC/Mac', desc: 'Mac OS (для РС-Hackintosh)' },
      {
        id: '208',
        cat: 'PC/Mac',
        desc: '[macOS] Архиваторы и файловые менеджеры',
      },
      {
        id: '204',
        cat: 'PC/Mac',
        desc: '[macOS] Проигрыватели и кодеки',
      },
      {
        id: '205',
        cat: 'PC/Mac',
        desc: '[macOS] Офисные приложения и редакторы',
      },
      {
        id: '206',
        cat: 'PC/Mac',
        desc: '[macOS] Работа с носителями и медиа',
      },
      {
        id: '939',
        cat: 'PC/Mac',
