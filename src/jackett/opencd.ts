...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    },
    {
      ...
      default:
        'For best results, change the <b>Torrents per page:</b> setting to <b>100</b> on your account profile. Default is 50.',
    },
    {
      name: 'sort',
      type: 'select',
    ...
    fields: {
      ...
      poster: {
        ...
        filters: [
          {
            name: 'prepend',
            args: 'https://images.weserv.nl/?url={{ .Config.sitelink }}',
          },
      ...
      description: { selector: 'td:nth-child(3)', remove: 'a, img' },
      minimumratio: { text: 1 },
