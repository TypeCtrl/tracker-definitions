...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://bwtorrents.tv/', 'https://bwtorrents.fun/', 'https://bwtorrents.xyz/'],
  caps: {
    categorymappings: [
      { id: '113', cat: 'Movies', desc: 'Bollywood-Pre-Release' },
      {
        id: '114',
        cat: 'Movies/UHD',
        desc: 'Bollywood-4K Ultra HD / Upscaled',
      },
      {
        id: '115',
        cat: 'Movies/BluRay',
        desc: 'Bollywood-Untouched BluRay',
      },
      {
        id: '116',
        cat: 'Movies/HD',
        desc: 'Bollywood-1080p BluRay Rips',
      },
      ...
      { id: '118', cat: 'Movies', desc: 'Bollywood-Remuxes BluRay' },
      {
        id: '119',
        cat: 'Movies/WEB-DL',
        desc: 'Bollywood-Untouched WEB-DLs',
      },
      {
        id: '120',
        cat: 'Movies/WEB-DL',
        desc: 'Bollywood-1080p WEB-Rips',
      },
      {
        id: '188',
        cat: 'Movies/WEB-DL',
        desc: 'Bollywood-720p WEB-Rips',
      },
      ...
      { id: '189', cat: 'Movies/DVD', desc: 'Bollywood-Encoded DVDs' },
      {
        id: '122',
        cat: 'Movies/WEB-DL',
        desc: 'Bollywood-DVDRips 1080p/720p',
      },
      {
        id: '123',
        cat: 'Movies/WEB-DL',
        desc: 'Bollywood-SDRips WEB/DVD',
      },
      ...
      { id: '190', cat: 'Movies', desc: 'Bollywood-Movies packs' },
      {
        id: '125',
        cat: 'Movies/WEB-DL',
        desc: 'Bollywood-WEB Originals',
      },
      {
        id: '126',
        cat: 'Movies/UHD',
        desc: 'Hollywood-4K Ultra HD / Upscaled',
      },
      {
        id: '127',
        cat: 'Movies/BluRay',
        desc: 'Hollywood-Untouched BluRay',
      },
      {
        id: '128',
        cat: 'Movies/HD',
        desc: 'Hollywood-1080p BluRay Rips',
      },
      ...
      { id: '130', cat: 'Movies', desc: 'Hollywood-BluRay Remuxes' },
      {
        id: '131',
        cat: 'Movies/WEB-DL',
        desc: 'Hollywood-Untouched WEB-DLs',
      },
      ...
      { id: '191', cat: 'Movies/WEB-DL', desc: 'Hollywood-Encoded DVDs' },
      {
        id: '134',
        cat: 'Movies/WEB-DL',
        desc: 'Hollywood-DVDRips 1080p/720p',
      },
      ...
      { id: '187', cat: 'XXX', desc: 'Adult XXX 18+' },
      {
        id: '199',
        cat: 'Movies',
        desc: 'Telgu-Movies | 4K Ultra HD - Upscaled',
      },
      {
        id: '200',
        cat: 'Movies',
        desc: 'Telgu-Movies | Untouched WEB-DLs',
      },
      {
        id: '201',
        cat: 'Movies',
        desc: 'Telgu-Movies | 1080p/720p WEBRips',
      },
      {
        id: '202',
        cat: 'Movies',
        desc: 'Telgu-Movies | Untouched BluRay',
      },
      ...
      { id: '203', cat: 'Movies', desc: 'Telgu-Movies | Untouched DVDs' },
      {
        id: '204',
        cat: 'Movies',
        desc: 'Telgu-Movies | SD-WEBRips / DVDRips',
      },
      { id: '205', cat: 'Movies', desc: 'Telgu-Movies | Movie Packs' },
      {
        id: '209',
        cat: 'Movies',
        desc: 'Tamil-Movies | 4K Ultra HD - Upscaled',
      },
      {
        id: '210',
        cat: 'Movies',
        desc: 'Tamil-Movies | Untouched WEB-DLs',
      },
      {
        id: '211',
        cat: 'Movies',
        desc: 'Tamil-Movies | 1080p/720p WEBRips',
      },
      {
        id: '212',
        cat: 'Movies',
        desc: 'Tamil-Movies | Untouched BluRay',
      },
      ...
      { id: '213', cat: 'Movies', desc: 'Tamil-Movies | Untouched DVDs' },
      {
        id: '214',
        cat: 'Movies',
        desc: 'Tamil-Movies | SD-WEBRips / DVDRips',
      },
  ...
  search: {
    ...
    fields: {
      ...
      uploadvolumefactor: {
        case: { 'img[src="pic/double_upload.png"]': 2, '*': 1 },
      },
      minimumratio: { text: 1 },
