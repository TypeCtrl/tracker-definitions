...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    { name: 'twofa', type: 'text', label: '2FA code' },
    {
      name: 'info_2fa',
      type: 'info',
      label: 'About 2FA code',
      default:
        'Only fill in the <b>2FA code</b> box if you have enabled <b>2FA</b> on the Desitorrents Web Site. Otherwise just leave it empty.',
    },
    {
      name: 'sort',
      type: 'select',
      ...
      default: 'relevance',
      options: { seeders: 'seeders', size: 'size', relevance: 'title' },
    },
  ],
  login: {
    ...
    error: [{ selector: 'form#loginform:has(span.warning)' }],
    test: { path: 'ajax.php' },
  },
  search: {
    paths: [{ path: 'ajax.php?action=search_torrent_cats', method: 'post' }],
    inputs: {
    ...
    error: [{ selector: ':contains("Something was wrong with your request")' }],
    ...
    fields: {
      category: {
        ...
        case: {
          ...
          'img[src*="Mac Games.png"]': 79,
          'img[src*="IOS Games.png"]': 80,
          'img[src*="Android Games.png"]': 81,
          'img[src*="XBOX Games.png"]': 83,
          'img[src*="Playstation Games.png"]': 86,
          ...
          'img[src*="Adult Videos.png"]': 89,
          'img[src*="Adult Pics.png"]': 90,
