...
export const definition: TrackerDefinition = {
  ...
  search: {
    ...
    fields: {
      ...
      title: { selector: 'div a.tor-name' },
      details: { selector: 'div a.tor-name', attribute: 'href' },
      download: {
      ...
      seeders: { selector: 'div.tor-sl b' },
      leechers: { selector: 'div.tor-sl b:last-of-type' },
      date: {
      ...
      downloadvolumefactor: {
        case: { 'img[src="pic/ou_new.png"]': '0', '*': '1' },
      },
