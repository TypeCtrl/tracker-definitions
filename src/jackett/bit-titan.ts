...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    { name: 'password', type: 'password', label: 'Password' },
    {
      ...
      default: '1',
      options: { '1': 'created', '2': 'title', '6': 'size', '8': 'seeders' },
    },
    {
      name: 'type',
      type: 'select',
  ...
  search: {
    ...
    fields: {
      ...
      title: { selector: 'a.tor-name' },
      details: { selector: 'a.tor-name', attribute: 'href' },
      download: { selector: 'div.tor-metadl a', attribute: 'href' },
      banner: { selector: 'div[id^="details-"] img', attribute: 'src' },
      seeders: { selector: 'div.tor-seeder' },
      leechers: { selector: 'div.tor-leecher' },
      grabs: { selector: 'div.tor-snatcher' },
      date: {
