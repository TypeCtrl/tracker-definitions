...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      {
        id: '/applications/other-applications/',
        cat: 'PC/Mobile-Other',
        desc: 'Apps Other',
      },
      {
        id: '/applications/windows/',
        cat: 'PC/0day',
        desc: 'Apps Windows',
      },
      { id: '/books/', cat: 'Books', desc: 'Books' },
      {
        id: '/books/audio-books/',
        cat: 'Audio/Audiobook',
      ...
      {
        id: '/music/other-music/',
        cat: 'Audio/Other',
        desc: 'Music Other',
      },
      {
        id: '/music/radio-shows/',
        cat: 'Audio',
        desc: 'Music Radio Shows',
      },
