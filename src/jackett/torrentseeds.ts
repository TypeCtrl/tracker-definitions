...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://www.torrentseeds.org/'],
  caps: {
    categorymappings: [
  ...
  settings: [
    ...
    { name: 'password', type: 'password', label: 'Password' },
    {
      ...
      default:
        'For best results, change the <b>Torrents per page</b> setting to <b>100</b> on your <b>Torrent</b> tab from the <b>Pers Tools > UserCP</b> menu on the TorrentSeeds webpage.',
    },
    {
      name: 'sort',
      type: 'select',
  ...
  search: {
    ...
    rows: { selector: 'table.torrent-table tr[class]' },
    fields: {
      category: {
      ...
      files: { selector: 'td.torrent-table-files' },
      date: {
        selector: 'td.torrent-table-added',
        filters: [{ name: 'timeago' }],
      },
      size: { selector: 'td.torrent-table-size' },
      grabs: { selector: 'td.torrent-table-snatched' },
      seeders: { selector: 'td.torrent-table-seeders' },
      leechers: { selector: 'td.torrent-table-leechers' },
