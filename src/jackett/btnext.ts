...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    },
    {
      ...
      default:
        "If you get 0 results check the log for error: <b>An error has occured!You can't view this page unless you read all your unread messages</b>, then access the site with your browser and <b>mark as read</b> all PMs.",
    },
  ],
  login: {
    path: '?p=home&pid=1',
