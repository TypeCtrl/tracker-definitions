  ...
  caps: {
    categorymappings: [
      ...
      { id: '154', cat: 'Movies/HD', desc: 'Зарубежное кино (HD Video)' },
      {
        id: '153',
        cat: 'Movies/DVD',
        desc: 'Зарубежное кино (DVD Video)',
      },
      { id: '157', cat: 'Movies/3D', desc: 'Кино в 3D' },
      {
        id: '5',
        cat: 'Movies/SD',
        desc: 'Зарубежное кино (DVDRip, HQRip)',
      },
      {
        id: '6',
        cat: 'Movies/Foreign',
        desc: 'Наше кино (DVDRip, HQRip)',
      },
      {
        id: '235',
        cat: 'Movies/Other',
        desc: 'Мультфильмы и мультсериалы',
      },
      ...
      { id: '824', cat: 'TV/Sport', desc: 'Спорт' },
      {
        id: '9',
        cat: 'TV/Other',
        desc: 'TV, развлекательные шоу, приколы и юмор',
      },
      ...
      { id: '617', cat: 'Books/Magazines', desc: 'Журналы' },
      { id: '488', cat: 'PC', desc: 'Программы' },
      { id: '492', cat: 'PC/Mac', desc: 'ОС и ПО для Apple Macintosh' },
      {
        id: '799',
        cat: 'PC/Phone-IOS',
        desc: 'iPhone, iPod Touch, iPad',
      },
      { id: '800', cat: 'PC/Phone-Android', desc: 'Android' },
      ...
      { id: '161', cat: 'Other', desc: 'Индийское кино' },
      {
        id: '162',
        cat: 'Other',
        desc: 'Фильмы без перевода (Зарубежное кино)',
      },
      {
        id: '164',
        cat: 'Other',
        desc: 'Зарубежное кино, экранки (CamRip, TS, Screener)',
      },
      ...
      { id: '167', cat: 'Other', desc: 'Многосерийные фильмы СССР' },
      {
        id: '168',
        cat: 'Other',
        desc: 'Нелицензионные сборники на DVD (Наше)',
      },
      {
        id: '169',
        cat: 'Other',
        desc: 'Наше кино, экранки (CamRip, TS, Screener)',
      },
      ...
      { id: '217', cat: 'Other', desc: 'Вокруг света' },
      {
        id: '218',
        cat: 'Other',
        desc: 'Документальные фильмы (HD & HQ Video)',
      },
      ...
      { id: '900', cat: 'Other', desc: 'Космос' },
      {
        id: '901',
        cat: 'Other',
        desc: 'Концепция Общественной Безопасности',
      },
      ...
      { id: '1037', cat: 'Other', desc: 'Flash, Flex и ActionScript' },
      {
        id: '1038',
        cat: 'Other',
        desc: 'Инженерные и научные программы',
      },
      ...
      { id: '1018', cat: 'Other', desc: 'Зарубежные сказки' },
      {
        id: '1019',
        cat: 'Other',
        desc: 'Детские фильмы (отечественные)',
      },
      ...
      { id: '1021', cat: 'Other', desc: 'Детская литература' },
      {
        id: '1022',
        cat: 'Other',
        desc: 'Детская литература (аудиокникги)',
      },
      ...
      { id: '367', cat: 'Other', desc: 'Русская озвучка' },
      {
        id: '368',
        cat: 'Other',
        desc: 'Оригинальная озвучка + cубтитры',
      },
      { id: '353', cat: 'Other', desc: 'Аниме с русской озвучкой' },
      {
        id: '369',
        cat: 'Other',
        desc: 'Архив (Аниме с русской озвучкой)',
      },
      ...
      { id: '374', cat: 'Other', desc: 'OVA (HD Video)' },
      {
        id: '354',
        cat: 'Other',
        desc: 'Аниме c оригинальной озвучкой / субтитрами',
      },
      {
        id: '375',
        cat: 'Other',
        desc: 'Архив (Аниме c оригинальной озвучкой / субтитрами)',
      },
      ...
      { id: '380', cat: 'Other', desc: 'Архив (Полнометражное аниме)' },
      {
        id: '381',
        cat: 'Other',
        desc: 'Полнометражное аниме (DVDRip, HQRip) c русской озвучкой',
      },
      {
        id: '382',
        cat: 'Other',
        desc: 'Полнометражное аниме (HD Video) c оригинальной озвучкой',
      },
      {
        id: '383',
        cat: 'Other',
        desc: 'Полнометражное аниме (HD Video) c русской озвучкой',
      },
      {
        id: '384',
        cat: 'Other',
        desc: 'Полнометражное аниме (DVDRip, HQRip) c оригинальной озвучкой',
      },
      ...
      { id: '398', cat: 'Other', desc: 'Hentai с русской озвучкой' },
      {
        id: '399',
        cat: 'Other',
        desc: 'Hentai с оригинальной озвучкой / субтитрами',
      },
      ...
      { id: '770', cat: 'Other', desc: 'Psy/Goa trance' },
      {
        id: '771',
        cat: 'Other',
        desc: 'Chillou t / Lounge / Downtempo / Trip-Hop',
      },
      ...
      { id: '955', cat: 'Other', desc: 'Рок, Панк, Метал, Альтернатива' },
      {
        id: '949',
        cat: 'Other',
        desc: 'Дискографии (Рок, Панк, Метал, Альтернатива)',
      },
      ...
      { id: '407', cat: 'Other', desc: 'Многопользовательские игры' },
      {
        id: '439',
        cat: 'Other',
        desc: 'Архив (Многопользовательские игры)',
      },
      { id: '440', cat: 'Other', desc: 'Бета-тестирование' },
      {
        id: '441',
        cat: 'Other',
        desc: 'Обновления для Многопользовательских игр',
      },
      ...
      { id: '451', cat: 'Other', desc: 'Архив (Казуальные и мини-игры)' },
      {
        id: '452',
        cat: 'Other',
        desc: 'Я ищу (Hidden Objects) / Квесты (Quests)',
      },
      {
        id: '453',
        cat: 'Other',
        desc: 'Тайм-Менеджмент (Time-Management)',
      },
      ...
      { id: '415', cat: 'Other', desc: 'Сопутствующий играм контент' },
      {
        id: '472',
        cat: 'Other',
        desc: 'Архив (Сопутствующий играм контент)',
      },
      ...
      { id: '869', cat: 'Other', desc: 'Женский баскетбол' },
      {
        id: '870',
        cat: 'Other',
        desc: 'Обзорные и аналитические передачи, видиоклипы и т.д.',
      },
      ...
      { id: '518', cat: 'Other', desc: 'Другие программы для Mac OS' },
      {
        id: '519',
        cat: 'Other',
        desc: 'Архив (Linux, Unix и другие ОС)',
      },
      ...
      },
      {
        id: '524',
        cat: 'Other',
        desc: 'Среды программирования, компиляторы и вспомогательные программы',
      },
      {
        id: '525',
        cat: 'Other',
      ...
      { id: '529', cat: 'Other', desc: 'Веб-разработка' },
      {
        id: '746',
        cat: 'Other',
        desc: 'Скрипты и движки сайтов, CMS а также расширения к ним',
      },
      {
        id: '530',
        cat: 'Other',
      ...
      { id: '531', cat: 'Other', desc: 'Архив (Системные программы)' },
      {
        id: '532',
        cat: 'Other',
        desc: 'Ключи и обновления для антивирусов и других системных программ',
      },
      ...
      { id: '572', cat: 'Other', desc: 'Photostoсks' },
      {
        id: '573',
        cat: 'Other',
        desc: 'Заготовки, виньетки, рамки, костюмы',
      },
      ...
      },
      {
        id: '498',
        cat: 'Other',
        desc: 'Географические информационные системы (ГИС)',
      },
      {
        id: '581',
        cat: 'Other',
        desc: 'Географические информационные системы (ГИС)(Архив)',
      },
      ...
      { id: '583', cat: 'Other', desc: 'Ноутбуки (Драйверы)' },
      {
        id: '584',
        cat: 'Other',
        desc: 'Сетевое оборудование (Драйверы)',
      },
      {
        id: '585',
        cat: 'Other',
        desc: 'Клавиатуры, мыши, джойстики (Драйверы)',
      },
      ...
      { id: '589', cat: 'Other', desc: 'DirectX' },
      {
        id: '590',
        cat: 'Other',
        desc: 'Принтеры и МФУ, Сканеры (Драйверы)',
      },
      ...
      { id: '1008', cat: 'Other', desc: 'Pron' },
      {
        id: '687',
        cat: 'Other',
        desc: 'Общение и Обсуждение порноиндустрии',
      },
      {
        id: '694',
        cat: 'Other',
        desc: "Правила, Инструкции, FAQ-и / Rules &amp; FAQ's",
      },
      ...
      },
      {
        id: '699',
        cat: 'Other',
        desc: '101 Величайший Порно Фильм 20 Века',
      },
      ...
      { id: '701', cat: 'Other', desc: 'Классические фильмы / Classic' },
      {
        id: '702',
        cat: 'Other',
        desc: 'Фильмы с сюжетом / Feature &amp; Vignettes',
      },
      { id: '703', cat: 'Other', desc: 'Гонзо-фильмы / Gonzo' },
      {
        id: '704',
        cat: 'Other',
        desc: 'Зарубежный Pron (DVD, HD Video)',
      },
      {
        id: '705',
        cat: 'Other',
        desc: 'Фильмы без сюжета / All Sex &amp; Amateur',
      },
      {
        id: '706',
        cat: 'Other',
      ...
      { id: '713', cat: 'Other', desc: "Сайтрипы / SiteRip's" },
      {
        id: '714',
        cat: 'Other',
        desc: 'Сцены из фильмов / Movie Scenes',
      },
      {
        id: '715',
        cat: 'Other',
      ...
      },
      {
        id: '691',
        cat: 'Other',
        desc: 'Эротические студии и фото, журналы и комиксы',
      },
      {
        id: '725',
        cat: 'Other',
        desc: 'Фотографии в высоком качестве / Foto High Quality',
      },
      {
        id: '726',
        cat: 'Other',
      ...
      },
      {
        id: '729',
        cat: 'Other',
        desc: 'Фото Разное / Picture Gallery (various)',
      },
      {
        id: '730',
        cat: 'Other',
        desc: 'Журналы, комиксы, манга и рисунки / Magazines, Comics, Manga and Artwork',
      },
      {
        id: '731',
        cat: 'Other',
        desc: 'Тематическое и нетрадиционное фото / Misc &amp; Special Interest Picture Packs',
      },
      {
        id: '732',
        cat: 'Other',
        desc: 'Архив (Эротические студии и фото, журналы и комиксы)',
      },
    ...
    fields: {
      ...
      date: {
        ...
        filters: [
          ...
          { name: 'dateparse', args: '02 Jan 2006' },
        ],
      },
