  ...
  search: {
    ...
    fields: {
      ...
      date: {
        ...
        filters: [
          { name: 'replace', args: ['<', ''] },
          { name: 'replace', args: ['mo', ' months'] },
          { name: 'replace', args: ['s', ' seconds'] },
          { name: 'replace', args: ['m', ' minutes'] },
          { name: 'replace', args: ['h', ' hours'] },
          { name: 'replace', args: ['d', ' days'] },
          { name: 'replace', args: ['w', 'weeks'] },
          { name: 'replace', args: ['y', 'years'] },
          { name: 'timeago' },
        ],
      },
