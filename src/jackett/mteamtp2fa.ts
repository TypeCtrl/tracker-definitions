...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://kp.m-team.cc/'],
  legacylinks: ['https://tp.m-team.cc/', 'https://pt.m-team.cc/'],
  caps: {
    categorymappings: [
  ...
  settings: [
    ...
    },
    {
      ...
      label: 'About Titles',
      default:
        'For best results disable the torrent name tooltip (User CP/Tracker Settings/Torrents Page). Otherwise long release names will be cut off.',
    },
    {
      name: 'sort',
      type: 'select',
  ...
  search: {
    ...
    fields: {
      ...
      size: { selector: 'td.rowfollow:nth-last-child(6)' },
      grabs: { selector: 'td.rowfollow:nth-last-child(3)' },
      seeders: { selector: 'td.rowfollow:nth-last-child(5)' },
      leechers: { selector: 'td.rowfollow:nth-last-child(4)' },
      date: {
