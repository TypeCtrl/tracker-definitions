...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://720pier.ru/'],
  legacylinks: ['http://720pier.ru/'],
  caps: {
    categorymappings: [
      ...
      { id: '87', cat: 'TV/Sport', desc: 'Basketball - NBA Playoffs' },
      {
        id: '81',
        cat: 'TV/Sport',
        desc: 'Basketball - NBA Playoffs - 2016',
      },
      {
        id: '95',
        cat: 'TV/Sport',
        desc: 'Basketball - NBA Playoffs - 2017',
      },
      {
        id: '58',
        cat: 'TV/Sport',
        desc: 'Basketball - NBA (до 2015 г.)',
      },
      ...
      { id: '82', cat: 'TV/Sport', desc: 'Basketball - WNBA' },
      {
        id: '36',
        cat: 'TV/Sport',
        desc: 'Basketball - European basketball',
      },
      {
        id: '37',
        cat: 'TV/Sport',
        desc: 'Basketball - World Championship',
      },
      {
        id: '51',
        cat: 'TV/Sport',
        desc: 'Basketball - Reviews and highlights',
      },
      ...
      { id: '101', cat: 'TV/Sport', desc: 'Football - AAF' },
      {
        id: '54',
        cat: 'TV/Sport',
        desc: 'Football - Reviews and highlights',
      },
      ...
      { id: '65', cat: 'TV/Sport', desc: 'Hockey - Stanley Cup Finals' },
      {
        id: '69',
        cat: 'TV/Sport',
        desc: 'Hockey - Stanley Cup Finals - 2005-2014',
      },
      {
        id: '70',
        cat: 'TV/Sport',
        desc: 'Hockey - Stanley Cup Finals - 2003',
      },
      ...
      { id: '68', cat: 'TV/Sport', desc: 'Hockey - Documentaries' },
      {
        id: '64',
        cat: 'TV/Sport',
        desc: 'Hockey - Reviews and highlights',
      },
      ...
      { id: '72', cat: 'TV/Sport', desc: 'Baseball - Other' },
      {
        id: '85',
        cat: 'TV/Sport',
        desc: 'Baseball - Reviews, highlights, documentaries',
      },
      ...
      { id: '100', cat: 'TV/Sport', desc: 'Soccer - MLS' },
      {
        id: '62',
        cat: 'TV/Sport',
        desc: 'Soccer - Other tournaments, championships',
      },
  ...
  search: {
    ...
    fields: {
      ...
      date: { selector: 'div.left-box time' },
