  ...
  caps: {
    categorymappings: [
      ...
      { id: '174', cat: 'PC', desc: 'AUDIOAPPS Steinberg' },
      {
        id: '34',
        cat: 'PC',
        desc: 'AUDIOAPPS Mastering &Audio Editor Apps',
      },
      ...
      { id: '117', cat: 'Audio', desc: 'SAMPLE LIBRARIES Bela D Media' },
      {
        id: '118',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Beta Monkey Music',
      },
      ...
      { id: '66', cat: 'Audio', desc: 'SAMPLE LIBRARIES Bigga Giggas' },
      {
        id: '122',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Bluezone Corporation',
      },
      { id: '123', cat: 'Audio', desc: 'SAMPLE LIBRARIES Bunker 8' },
      {
        id: '126',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Cinematique Instruments',
      },
      ...
      { id: '40', cat: 'Audio', desc: 'SAMPLE LIBRARIES East West' },
      {
        id: '74',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Electronisounds',
      },
      ...
      { id: '75', cat: 'Audio', desc: 'SAMPLE LIBRARIES Ilio' },
      {
        id: '108',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Industrial Strength Records',
      },
      {
        id: '81',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES KURZWEIL format',
      },
      ...
      { id: '137', cat: 'Audio', desc: 'SAMPLE LIBRARIES Mystic Kingz' },
      {
        id: '47',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Native Instruments',
      },
      {
        id: '60',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Nine Volt Audio',
      },
      ...
      { id: '154', cat: 'Audio', desc: 'SAMPLE LIBRARIES P5Audio' },
      {
        id: '133',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Peace Love Productions',
      },
      ...
      { id: '110', cat: 'Audio', desc: 'SAMPLE LIBRARIES Prime Loops' },
      {
        id: '180',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Producer Loops',
      },
      { id: '50', cat: 'Audio', desc: 'SAMPLE LIBRARIES Prominy' },
      {
        id: '171',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Pulsed Records',
      },
      ...
      { id: '48', cat: 'Audio', desc: 'SAMPLE LIBRARIES Scarbee' },
      {
        id: '178',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES SFX (Sound FX libraries)',
      },
      ...
      { id: '56', cat: 'Audio', desc: 'SAMPLE LIBRARIES Sony' },
      {
        id: '139',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Sounds To Sample',
      },
      { id: '76', cat: 'Audio', desc: 'SAMPLE LIBRARIES Spectrasonics' },
      {
        id: '162',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Spitfire Audio',
      },
      ...
      { id: '179', cat: 'Audio', desc: 'SAMPLE LIBRARIES The Loop Loft' },
      {
        id: '96',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Tonehammer, 8dio, SoundIron',
      },
      {
        id: '67',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Toontrack, Drumkit From Hell, DFHS',
      },
      ...
      { id: '157', cat: 'Audio', desc: 'SAMPLE LIBRARIES USB Soundscan' },
      {
        id: '120',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Valentino Production',
      },
      {
        id: '173',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES vandalism sounds',
      },
      {
        id: '170',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Vanilla Groove Studios',
      },
      {
        id: '119',
        cat: 'Audio',
        desc: 'SAMPLE LIBRARIES Vengeance Sound',
      },
      ...
      { id: '101', cat: 'Books', desc: 'LEARNING Magazines' },
      {
        id: '93',
        cat: 'Books',
        desc: 'LEARNING Music Video (Concerts, DVD, DVDrip)',
      },
      ...
      { id: '167', cat: 'Audio/Other', desc: 'PRESETS Ableton Live' },
      {
        id: '184',
        cat: 'Audio/Other',
        desc: 'PRESETS Impulse Responses',
      },
      ...
      { id: '227', cat: 'Other', desc: 'GFXNEWS PHOTOSHOP' },
      {
        id: '228',
        cat: 'Other',
        desc: 'GFXNEWS PHOTOSHOP Actions, Pattern & Styles',
      },
      {
        id: '229',
        cat: 'Other',
        desc: 'GFXNEWS PHOTOSHOP Background & PSD Source',
      },
      {
        id: '230',
        cat: 'Other',
        desc: 'GFXNEWS PHOTOSHOP Brushes & Gradient',
      },
      {
        id: '231',
        cat: 'Other',
        desc: 'GFXNEWS PHOTOSHOP Toolkits, Papers & Objects',
      },
      ...
      { id: '210', cat: 'Other', desc: 'GFXNEWS PLUGINS WIN' },
      {
        id: '217',
        cat: 'Other',
        desc: 'GFXNEWS SCRIPTS - WEB PROGRAMMING',
      },
    ...
    error: [
      {
        ...
        message: { selector: 'table.error tr td div.msg' },
      },
    ],
    test: { path: '/', selector: 'li a[href^="./login.php?logout=1"]' },
  },
  search: {
    ...
    rows: {
      ...
      dateheaders: {
        ...
        filters: [{ name: 'dateparse', args: '01-02-2006' }],
      },
    },
    fields: {
