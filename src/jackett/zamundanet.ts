...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '7', cat: 'TV/SD', desc: 'Serial' },
      { id: '33', cat: 'TV/HD', desc: 'Serial/HD' },
  ...
  search: {
    ...
    headers: { cookie: ['xporn=1'] },
    rows: {
      selector:
        '.responsetop > tbody > tr:has(a[href^="banan?id="]){{ if .Config.freeleech }}:has(a[style="color: #b9a100;"]){{ else }}{{ end }}',
    },
    fields: {
      title: {
        ...
        filters: [
          { name: 'regexp', args: " (.+?)'" },
          { name: 're_replace', args: [' rq$', ''] },
        ],
      },
      details: { selector: 'a[href^="banan?id="]', attribute: 'href' },
      category: {
