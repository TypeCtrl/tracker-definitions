...
export const definition: TrackerDefinition = {
  ...
  ratio: { path: 'browse', selector: 'font:contains("Ratio:")+font' },
  search: {
    paths: [{ path: 'browse' }],
    inputs: {
    ...
    rows: {
      selector:
        'div[class="kt-container  kt-grid__item"] > div:not(#top10-wrapper) div[class^="row mr-0"]',
    },
    fields: {
      ...
      date: {
        ...
        attribute: 'title',
        filters: [{ name: 'dateparse', args: 'Jan 02, 2006, 03:04:05 PM' }],
      },
      grabs: {
