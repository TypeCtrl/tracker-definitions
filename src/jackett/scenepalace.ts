...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '2', cat: 'Movies', desc: 'Movies' },
      {
        id: '16',
        cat: 'Movies/Foreign',
        desc: 'Movies/Foriegn Non English',
      },
  ...
  search: {
    ...
    rows: {
      selector:
        'table[border="1"][cellpadding=5] > tbody > tr:has(a[href^="download.php?torrent="])',
    },
    fields: {
