  ...
  caps: {
    categorymappings: [
      ...
      },
      {
        id: '1635',
        cat: 'Audio/MP3',
        desc: 'Зарубежная музыка (Disco, Italo-Disco, Eurodance,..',
      },
      {
        id: '1636',
        cat: 'Audio/MP3',
        desc: ' |- Сборники поп музыки (50/50 общие mp3)',
      },
      {
        id: '1647',
        cat: 'Audio/Lossless',
      ...
      },
      {
        id: '1643',
        cat: 'Audio/MP3',
        desc: ' |- Зарубежная поп музыка (альбомы, синглы mp3)',
      },
      {
        id: '1637',
        cat: 'Audio/MP3',
      ...
      },
      {
        id: '1655',
        cat: 'Audio/Lossless',
        desc: ' |- Eurodance, Disco, Hi-NRG, Technopop (Lossless)',
      },
      {
        id: '1654',
        cat: 'Audio/MP3',
        desc: ' |- Eurodance, Disco, Hi-NRG, Technopop (mp3)',
      },
      {
        id: '1638',
        cat: 'Audio/MP3',
        desc: ' |- Eurodance, Disco, Hi-NRG, Technopop (Сборники mp3)',
      },
      {
        id: '1639',
        cat: 'Audio/MP3',
        desc: ' |- Club, Dance, Hands Up (Сборники mp3)',
      },
      {
        id: '1640',
        cat: 'Audio/Lossless',
        desc: ' |- Зарубежный шансон (mp3, Lossless)',
      },
      {
        id: '1177',
        cat: 'Audio/MP3',
      ...
      },
      {
        id: '1642',
        cat: 'Audio/MP3',
        desc: ' |- Российская попса (альбомы, синглы mp3)',
      },
      {
        id: '1644',
        cat: 'Audio/Lossless',
      ...
      },
      {
        id: '1641',
        cat: 'Audio/MP3',
        desc: ' |- Шансон и авторская песня (mp3)',
      },
      {
        id: '1561',
        cat: 'Audio/MP3',
      ...
      { id: '1168', cat: 'Audio/MP3', desc: 'Зарубежный ROCK' },
      {
        id: '1652',
        cat: 'Audio/Lossless',
        desc: ' |- Зарубежная рок музыка (Lossless)',
      },
      {
        id: '1200',
        cat: 'Audio/MP3',
      ...
      { id: '1579', cat: 'Audio/MP3', desc: 'Зарубежный Metal' },
      {
        id: '1653',
        cat: 'Audio/Lossless',
        desc: ' |- Зарубежный Metal (Lossless)',
      },
      {
        id: '1588',
        cat: 'Audio/MP3',
      ...
      { id: '1626', cat: 'Audio/MP3', desc: ' |- Зарубежный джаз (mp3)' },
      {
        id: '1625',
        cat: 'Audio/Lossless',
        desc: ' |- Зарубежный джаз (Lossless)',
      },
      { id: '1627', cat: 'Audio/MP3', desc: ' |- Зарубежный блюз (mp3)' },
      {
        id: '1624',
        cat: 'Audio/Lossless',
        desc: ' |- Зарубежный блюз (Lossless)',
      },
      {
        id: '1628',
        cat: 'Audio/MP3',
        desc: ' |- Отечественный джаз и блюз (mp3)',
      },
      {
        id: '1629',
        cat: 'Audio/Lossless',
        desc: ' |- Отечественный джаз и блюз (Lossless)',
      },
      { id: '1171', cat: 'Audio/MP3', desc: 'Электронная музыка' },
      {
        id: '1648',
        cat: 'Audio/Lossless',
        desc: ' |- Electronic and club music (Lossless)',
      },
      {
        id: '1610',
        cat: 'Audio/MP3',
      ...
      },
      {
        id: '1632',
        cat: 'Audio/Lossless',
        desc: ' |- Отечественный Рэп, Хип-Хоп (lossless)',
      },
      {
        id: '1633',
        cat: 'Audio/MP3',
        desc: ' |- Зарубежный Рэп, Хип-Хоп (mp3)',
      },
      {
        id: '1634',
        cat: 'Audio/Lossless',
        desc: ' |- Зарубежный Рэп, Хип-Хоп (lossless)',
      },
      {
        id: '1540',
        cat: 'Audio/MP3',
      ...
      },
      {
        id: '1651',
        cat: 'Audio/Lossless',
        desc: ' |- Классическая и инструментальная музыка (Lossless)',
      },
      {
        id: '1562',
        cat: 'Audio/MP3',
      ...
      },
      {
        id: '1649',
        cat: 'Audio/Lossless',
        desc: ' |- Other musical genres (Lossless)',
      },
      {
        id: '1183',
        cat: 'Audio/MP3',
      ...
      },
      {
        id: '1664',
        cat: 'Audio',
        desc: 'Оцифровки с аналоговых носителей',
      },
      {
        id: '1665',
        cat: 'Audio',
        desc: ' |- Зарубежная поп-музыка (Vinyl)',
      },
      {
        id: '1666',
        cat: 'Audio',
        desc: ' |- Зарубежная рок-музыка (Vinyl)',
      },
      { id: '1667', cat: 'Audio', desc: ' |- Джаз и блюз (Vinyl)' },
      {
        id: '1668',
        cat: 'Audio',
        desc: ' |- Электронная музыка (Vinyl)',
      },
      {
        id: '1669',
        cat: 'Audio',
        desc: ' |- Шансон, авторские, военные песни (Vinyl)',
      },
      {
        id: '1670',
        cat: 'Audio',
        desc: ' |- Отечественная поп-музыка (Vinyl)',
      },
      ...
      { id: '1287', cat: 'PC/Mobile-Other', desc: 'Видео' },
      {
        id: '1307',
        cat: 'PC/Mobile-Other',
        desc: ' |- Мобильные телефоны',
      },
      { id: '1306', cat: 'PC/Mobile-iOS', desc: ' |- iPhone' },
      { id: '1305', cat: 'PC/Mobile-iOS', desc: ' |- iPad' },
      { id: '1289', cat: 'PC', desc: 'Программы' },
      { id: '1302', cat: 'PC', desc: ' |- Мобильные телефоны' },
      { id: '1301', cat: 'PC/Mobile-Android', desc: ' |- Android OS' },
      { id: '1298', cat: 'PC', desc: ' |- Symbian OS' },
      { id: '1293', cat: 'PC/Mobile-Other', desc: ' |- Windows Mobile' },
      { id: '1292', cat: 'PC/Mobile-iOS', desc: ' |- iPhone' },
      { id: '1291', cat: 'PC/Mobile-iOS', desc: ' |- Apple Macintosh' },
      { id: '1294', cat: 'PC', desc: 'Игры' },
      { id: '1303', cat: 'PC', desc: ' |- Мобильные телефоны' },
      { id: '1300', cat: 'PC/Mobile-Android', desc: ' |- Android OS' },
      { id: '1299', cat: 'PC', desc: ' |- Symbian OS' },
      { id: '1296', cat: 'PC/Mobile-iOS', desc: ' |- iPhone' },
      { id: '1295', cat: 'PC/Mobile-Other', desc: ' |- Windows Mobile' },
