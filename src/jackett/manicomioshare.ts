...
export const definition: TopLevel = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '142', cat: 'Movies/BluRay', desc: 'Filmes: Blu-Ray BD25' },
      {
        id: '182',
        cat: 'Movies/BluRay',
        desc: 'Filmes: Blu-Ray BD25 Nacionais',
      },
      {
        id: '183',
        cat: 'Movies/BluRay',
        desc: 'Filmes: Blu-Ray BD25 3D',
      },
      ...
      { id: '144', cat: 'Movies/SD', desc: 'Filmes: DVD-R 9' },
      {
        id: '145',
        cat: 'Movies/Other',
        desc: 'Filmes: Documentarios DVD-R',
      },
      {
        id: '151',
        cat: 'Movies/Other',
        desc: 'Filmes: Documentarios HD',
      },
  ...
  search: {
    ...
    inputs: { busca: '{{ .Keywords }}' },
    rows: { selector: 'table#tbltorrent > tbody > tr[data-id]' },
    fields: {
      download: {
        selector: 'a[href*="/download.php?id="]',
        attribute: 'href',
      },
      details: { selector: 'a[href*="/item/"]', attribute: 'href' },
      category: {
      ...
      title: {
        ...
        filters: [
          ...
          { name: 're_replace', args: ['^The Flash', 'The Flash 2014'] },
          {
            name: 'replace',
            args: [
              'Nanatsu no Taizai - Imashime no Fukkatsu - E',
              'Nanatsu no Taizai - Imashime no Fukkatsu - S02E',
            ],
          },
          {
            name: 're_replace',
          ...
          { name: 'replace', args: ['O Sócio - The Profit', 'The Profit'] },
          {
            name: 'replace',
      ...
      downloadvolumefactor: {
        case: { 'span.h3t:contains("[livre]")': '0', '*': '1' },
      },
