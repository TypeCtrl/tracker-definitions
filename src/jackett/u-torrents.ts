...
export const definition: TrackerDefinition = {
  ...
  login: {
    ...
    error: [{ selector: 'div.card-body:contains("incorrect")' }],
    test: { path: 'index.php', selector: 'a[href^="logout.php?id="]' },
  },
  search: {
    paths: [{ path: 'browse' }],
    inputs: {
    ...
    rows: { selector: 'table.table > tbody > tr.browse' },
    fields: {
      category: {
      ...
      title_alternate: {
        ...
        attribute: 'href',
        filters: [
          { name: 're_replace', args: ['download.php/\\d+/', ''] },
      ...
      downloadvolumefactor: {
        case: { 'img[src="imagini/YNTdm1Jn_o.png"]': 0, '*': 1 },
      },
