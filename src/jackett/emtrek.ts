  ...
  caps: {
    categorymappings: [
      ...
      { id: '184', cat: 'TV/Sport', desc: ' |- Бокс' },
      {
        id: '185',
        cat: 'TV/Sport',
        desc: ' |- Смешанные единоборства и K-1',
      },
      ...
      { id: '318', cat: 'TV/Sport', desc: ' |- Разное' },
      {
        id: '200',
        cat: 'TV/Sport',
        desc: ' |- Международные соревнования',
      },
      { id: '201', cat: 'TV/Sport', desc: ' |- NBA / NCAA (до 2000 г.)' },
      {
        id: '202',
        cat: 'TV/Sport',
        desc: ' |- NBA / NCAA (2000-2010 гг.)',
      },
      {
        id: '203',
        cat: 'TV/Sport',
        desc: ' |- NBA / NCAA (2010-2011 гг.)',
      },
      {
        id: '204',
        cat: 'TV/Sport',
      ...
      { id: '211', cat: 'TV/Sport', desc: ' |- СССР - Канада' },
      {
        id: '212',
        cat: 'TV/Sport',
        desc: ' |- Документальные фильмы и аналитика',
      },
      ...
      { id: '94', cat: 'Audio', desc: 'Восточно-азиатская музыка' },
      {
        id: '95',
        cat: 'Audio/Video',
        desc: 'Музыкальное DVD и HD видео',
      },
      ...
      },
      {
        id: '249',
        cat: 'Audio',
        desc: ' |- Drum&Bass, Jungle, Breakbeat, Dubstep, IDM, Electro',
      },
      {
        id: '250',
        cat: 'Audio',
      ...
      },
      {
        id: '253',
        cat: 'Audio/Lossless',
        desc: ' |- Label Packs (lossless)',
      },
      {
        id: '254',
        cat: 'Audio/MP3',
        desc: ' |- Label packs, Scene packs (lossy)',
      },
      {
        id: '255',
        cat: 'Audio/Video',
        desc: ' |- Электронная музыка (Видео, DVD Video/Audio, HD Video,...',
      },
      ...
      },
      {
        id: '23',
        cat: 'PC',
        desc: 'Unix, Unix-подобные (*nix) и другие OS. Прогр...',
      },
      ...
      },
      {
        id: '98',
        cat: 'PC/0day',
        desc: ' |- Антивирусное ПО, Фаерволлы и защита информации',
      },
      { id: '118', cat: 'PC/0day', desc: ' |- Драйвера' },
      {
        id: '243',
        cat: 'PC/0day',
        desc: ' |- Оригинальные диски к компьютерам и комплектующим',
      },
      ...
      { id: '286', cat: 'PC/0day', desc: ' |- Редакторы видео' },
      {
        id: '288',
        cat: 'PC/0day',
        desc: ' |- Виртуальные студии, секвенсоры и аудиоредакторы',
      },
        ...
        filters: [
          {
            name: 'append',
            args:
              '&tr=udp://tracker.coppersurfer.tk:6969&tr=udp://tracker.leechers-paradise.org:6969&tr=udp://tracker.opentrackr.org:1337',
          },
        ],
      },
