...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: 'XONE', cat: 'Console/XboxOne', desc: 'Xbox ONE' },
      { id: 'X360', cat: 'Console/Xbox360', desc: 'Xbox 360' },
  ...
  search: {
    ...
    rows: { selector: 'div.short_game_search' },
    fields: {
      category: { selector: 'div.icon_default' },
      title: { selector: 'div.short_game_title' },
      details: { selector: 'a[href$=".html"]', attribute: 'href' },
      download: { selector: 'a[href$=".html"]', attribute: 'href' },
      poster: { selector: 'img', attribute: 'src' },
      description: { selector: 'div.short_game_genre', optional: true },
      date: { text: 'now' },
      seeders: { text: 1 },
      leechers: { text: 1 },
      size: { text: '512 MB' },
