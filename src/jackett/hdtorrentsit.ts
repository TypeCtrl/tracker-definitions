    ...
    fields: {
      title: {
        ...
        filters: [
          ...
          { name: 're_replace', args: ['(\\(\\d{4}\\))|(\\(\\d{4})', ''] },
          { name: 're_replace', args: ['(\\s\\|\\s)', ' '] },
          { name: 're_replace', args: ['Stagione (\\d{0,1}\\s)', 'S0$1'] },
          { name: 're_replace', args: ['Stagione (\\d{2}\\s)', 'S$1'] },
          {
            name: 're_replace',
            args: [
              '(\\s\\/\\sEpisodio|\\s\\/\\sEpisodi|\\sEpisodio|\\s\\|\\sEpisodio|\\sEpisodi)\\s\\[',
              'E',
            ],
          },
          {
