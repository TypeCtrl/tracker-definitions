  ...
  caps: {
    categorymappings: [
      ...
      { id: '6', cat: 'Movies', desc: 'Családi/Hun(Family)' },
      {
        id: '17',
        cat: 'Movies',
        desc: 'Családi/Romantikus/Cam(Family Romantic)',
      },
      {
        id: '16',
        cat: 'Movies',
        desc: 'Családi/Romantikus/Eng(Family Romantic)',
      },
      {
        id: '15',
        cat: 'Movies',
        desc: 'Családi/Romantikus/Hun(Family Romantic)',
      },
      {
        id: '18',
        cat: 'TV',
        desc: 'Családi/Romantikus/Sorozat(Family Romantic Series)',
      },
