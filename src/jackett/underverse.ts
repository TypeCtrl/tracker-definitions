  ...
  caps: {
    categorymappings: [
      { id: '797', cat: 'PC', desc: ' |- UV-Info - помощник релизера' },
      {
        id: '1007',
        cat: 'PC',
        desc: ' |- Proxygen - обходим блокировки',
      },
      ...
      { id: '361', cat: 'PC/Games', desc: ' |- Adventure/Quest' },
      {
        id: '650',
        cat: 'PC/Games',
        desc: ' |- Arcade/Platformer [Casual]',
      },
      {
        id: '365',
        cat: 'PC/Games',
        desc: ' |- Strategy [TBS/RTS/Grand/Manage]',
      },
      ...
      { id: '381', cat: 'PC/Games', desc: ' |- Прочие игры для PC' },
      {
        id: '389',
        cat: 'PC/Games',
        desc: ' |- NoCD/NoDVD/Mods/Rus/Crack/Patch/Other для Игр',
      },
      { id: '1141', cat: 'Console/Xbox360', desc: ' |- Xbox 360' },
