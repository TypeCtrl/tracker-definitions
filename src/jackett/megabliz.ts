...
export const definition: TopLevel = {
  ...
  settings: [
    ...
    },
    {
      ...
      default:
        "For best results, change the 'Torrents per page' setting to 100 on your 'Personal Options' from the 'Personal' menu on the Mega-Blitz webpage.",
    },
  ],
  login: {
    path: 'login.php',
  ...
  search: {
    ...
    fields: {
      ...
      date: {
        ...
        filters: [{ name: 'dateparse', args: 'Jan 02 2006 03:04 PM' }],
      },
