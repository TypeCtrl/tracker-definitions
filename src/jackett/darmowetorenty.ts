...
export const definition: TrackerDefinition = {
  ...
  type: 'semi-private',
  encoding: 'ISO-8859-2',
  links: ['https://darmowe-torenty.pl/'],
  caps: {
    categorymappings: [
      ...
      { id: '29', cat: 'Movies/BluRay', desc: 'Filmy BluRay/x264' },
      {
        id: '30',
        cat: 'Movies/SD',
        desc: 'Filmy DivX/XviD LEKTOR/NAPISY PL',
      },
      ...
      { id: '21', cat: 'Books', desc: 'Książki/Czasopisma' },
      {
        id: '47',
        cat: 'Books/Ebook',
        desc: 'Książki/Czasopisma E-Booki',
      },
      {
        id: '48',
        cat: 'Audio/Audiobook',
        desc: 'Książki/Czasopisma Audio-Booki',
      },
      {
        id: '49',
        cat: 'Books/Magazines',
        desc: 'Książki/Czasopisma Czasopisma',
      },
      {
        id: '50',
        cat: 'Books/Comics',
        desc: 'Książki/Czasopisma Komiksy',
      },
  ...
  login: {
    ...
    error: [{ selector: 'div:contains("Podany login jest")' }],
    test: {
      path: 'index.php',
  ...
  search: {
    ...
    rows: { selector: 'table.header > tbody > tr:has(td)', after: 1 },
    fields: {
      category: {
      ...
      title: { selector: 'a[href^="details.php?id="]:has(span)' },
      details: {
      ...
      leechers: {
        selector: 'p',
        optional: true,
        filters: [{ name: 'regexp', args: 'Leecherów: (\\d+)' }],
      },
