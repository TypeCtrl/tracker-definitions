...
export const definition: TrackerDefinition = {
  ...
  login: {
    ...
    error: [{ selector: 'td.loginerr' }],
    test: { path: 'browse.php' },
  },
  ratio: { path: 'browse.php', selector: 'a#link14' },
  search: {
    ...
    rows: {
      ...
      dateheaders: {
        ...
        filters: [
          { name: 'replace', args: ['Torrents Added: ', ''] },
          { name: 'dateparse', args: '2.1.2006' },
        ],
      },
    },
    fields: {
      title: { selector: 'a[href^="details.php?id="] font' },
      details: {
