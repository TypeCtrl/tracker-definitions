...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://www.dedbit.com/'],
  caps: {
    categorymappings: [
      {
        id: '1',
        cat: 'Other',
        desc: 'ในพระราชสำนัก (in the royal court)',
      },
      ...
      { id: '34', cat: 'Movies/DVD', desc: 'ภาพยนตร์ DVD (Movies DVD)' },
      {
        id: '35',
        cat: 'Movies/HD',
        desc: 'วีดีโอความละเอียดสูง (Movies HD)',
      },
      { id: '41', cat: 'Audio/MP3', desc: 'เพลง (Music)' },
      {
        id: '43',
        cat: 'Audio/Video',
        desc: 'มิวสิควีดีโอ (Music video)',
      },
      {
        id: '53',
        cat: 'PC/0day',
        desc: 'โปรแกรม/Windows (Software Windows)',
      },
      {
        id: '54',
        cat: 'PC/Mac',
        desc: 'โปรแกรม/Mac, Linux (Software Mac/Linux)',
      },
      {
        id: '55',
        cat: 'PC/Mobile-Other',
        desc: 'โปรแกรม/Mobile (Software Mobile)',
      },
  ...
  search: {
    ...
    fields: {
      ...
      downloadvolumefactor: {
        case: { 'img[src$="pic/freeload.png"]': 0, '*': 1 },
      },
