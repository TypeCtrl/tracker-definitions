...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '470', cat: 'Movies/HD', desc: 'HD Video' },
      {
        id: '476',
        cat: 'Movies/HD',
        desc: 'Новинки кинопроката (HD Video)',
      },
      { id: '481', cat: 'Movies/HD', desc: 'Зарубежное кино (HD Video)' },
      {
        id: '482',
        cat: 'Movies/HD',
        desc: 'Классика зарубежного кино (HD Video)',
      },
      { id: '483', cat: 'Movies/HD', desc: 'Мультфильмы (HD Video)' },
      {
        id: '484',
        cat: 'Movies/HD',
        desc: 'Российское/Бл. зарубежья кино (HD Video)',
      },
      ...
      { id: '684', cat: 'Movies/HD', desc: 'HEVC (H.265)' },
      {
        id: '533',
        cat: 'Movies/HD',
        desc: 'Бюджетные сцен-рипы (HD Video)',
      },
      ...
      { id: '477', cat: 'Movies/DVD', desc: 'Зарубежное кино (DVD)' },
      {
        id: '478',
        cat: 'Movies/DVD',
        desc: 'Классика зарубежного кино (DVD)',
      },
      { id: '479', cat: 'Movies/DVD', desc: 'Мультфильмы (DVD)' },
      {
        id: '480',
        cat: 'Movies/DVD',
        desc: 'Российское и казахстанское кино (DVD)',
      },
      ...
      { id: '247', cat: 'Movies', desc: 'Отечественные мультфильмы' },
      {
        id: '351',
        cat: 'TV/Documentary',
        desc: 'Док. фильмы и телепередачи',
      },
      {
        id: '352',
        cat: 'TV/Documentary',
        desc: 'BBC, Discovery, NG, AP',
      },
      ...
      { id: '359', cat: 'TV/Documentary', desc: 'Развлекательные' },
      {
        id: '455',
        cat: 'TV/Documentary',
        desc: 'На ин. языке (Документалистика)',
      },
      {
        id: '363',
        cat: 'TV/Documentary',
        desc: 'Разное (Документалистика)',
      },
      {
        id: '383',
        cat: 'TV/Documentary',
        desc: 'Документальное кино (HD Video)',
      },
      ...
      { id: '140', cat: 'TV/Sport', desc: 'Другие спортивные передачи' },
      {
        id: '570',
        cat: 'TV/Sport',
        desc: 'Спортивные передачи (HD VIDEO)',
      },
      { id: '16', cat: 'TV', desc: 'Зарубежные сериалы' },
      {
        id: '623',
        cat: 'TV',
        desc: '100 (Сотня) / The Hundred (The 100)',
      },
      ...
      { id: '333', cat: 'TV', desc: 'Латиноамериканские сериалы' },
      {
        id: '593',
        cat: 'TV',
        desc: 'Турецкие сериалы / Turkish serials',
      },
      ...
      { id: '382', cat: 'TV', desc: 'Трейлеры и доп. материалы (ЗС)' },
      {
        id: '387',
        cat: 'TV',
        desc: 'Сериалы России и ближнего зарубежья',
      },
      ...
      { id: '79', cat: 'TV', desc: 'Др. сериалы России и бл. зарубежья' },
      {
        id: '566',
        cat: 'TV',
        desc: 'Др. сериалы России и бл. зарубежья HD',
      },
      ...
      { id: '14', cat: 'Audio/MP3', desc: 'Музыка (mp3)' },
      {
        id: '37',
        cat: 'Audio/MP3',
        desc: 'Зарубежный Rap / Hip-Hop (mp3)',
      },
      {
        id: '365',
        cat: 'Audio/MP3',
        desc: 'Русский Rap / Hip-Hop (mp3)',
      },
      ...
      { id: '97', cat: 'Audio/MP3', desc: 'House (mp3)' },
      {
        id: '200',
        cat: 'Audio/MP3',
        desc: 'Ambient / Chillout / NewAge (mp3)',
      },
      { id: '454', cat: 'Audio/MP3', desc: 'Trance (mp3)' },
      {
        id: '39',
        cat: 'Audio/MP3',
        desc: 'Pop / Disco / Eurodance (mp3)',
      },
      ...
      { id: '547', cat: 'Audio/MP3', desc: 'Блюз-рок (mp3)' },
      {
        id: '109',
        cat: 'Audio/MP3',
        desc: 'Инструментальная музыка (mp3)',
      },
      { id: '208', cat: 'Audio/MP3', desc: 'Казахстанская музыка (mp3)' },
      {
        id: '561',
        cat: 'Audio/MP3',
        desc: 'Восточноазиатская Pop музыка (MP3)',
      },
      {
        id: '562',
        cat: 'Audio/MP3',
        desc: 'Восточноазиатская Rock музыка (MP3)',
      },
      ...
      { id: '107', cat: 'Audio/MP3', desc: 'Саундтреки (OST) (mp3)' },
      {
        id: '466',
        cat: 'Audio/MP3',
        desc: 'Фольклорная / Этническая музыка (mp3)',
      },
      { id: '41', cat: 'Audio/MP3', desc: 'Другая музыка (mp3)' },
      {
        id: '465',
        cat: 'Audio/MP3',
        desc: 'Неофициальные сборники (mp3)',
      },
      ...
      },
      {
        id: '291',
        cat: 'Audio/Lossless',
        desc: 'Русский Rap/Hip-Hop (lossless)',
      },
      {
        id: '293',
        cat: 'Audio/Lossless',
        desc: 'Зарубежный рок (lossless)',
      },
      { id: '295', cat: 'Audio/Lossless', desc: 'Панк рок (lossless)' },
      {
        id: '292',
        cat: 'Audio/Lossless',
        desc: 'Русский рок (lossless)',
      },
      { id: '294', cat: 'Audio/Lossless', desc: 'Метал (lossless)' },
      {
        id: '349',
        cat: 'Audio/Lossless',
        desc: 'Drum & Bass (lossless)',
      },
      ...
      { id: '299', cat: 'Audio/Lossless', desc: 'House (lossless)' },
      {
        id: '298',
        cat: 'Audio/Lossless',
        desc: 'Meditative/Trance/NewAge (lossless)',
      },
      ...
      { id: '548', cat: 'Audio/Lossless', desc: 'Блюз-рок (lossless)' },
      {
        id: '305',
        cat: 'Audio/Lossless',
        desc: 'Инструментальная музыка (lossless)',
      },
      {
        id: '303',
        cat: 'Audio/Lossless',
        desc: 'Казахстанская музыка (lossless)',
      },
      {
        id: '306',
        cat: 'Audio/Lossless',
      ...
      },
      {
        id: '304',
        cat: 'Audio/Lossless',
        desc: 'Саундтреки (OST) (lossless)',
      },
      {
        id: '307',
        cat: 'Audio/Lossless',
        desc: 'Другая музыка (lossless)',
      },
      ...
      { id: '128', cat: 'Audio/Video', desc: 'Шансон (Клипы)' },
      {
        id: '129',
        cat: 'Audio/Video',
        desc: 'Инструментальная музыка (Клипы)',
      },
      { id: '209', cat: 'Audio/Video', desc: 'Казахстанские клипы' },
      {
        id: '564',
        cat: 'Audio/Video',
        desc: 'Восточноазиатская Pop музыка (Клипы)',
      },
      {
        id: '616',
        cat: 'Audio/Video',
        desc: 'Саундтреки (OST) (Клипы)  ',
      },
      {
        id: '99',
        cat: 'Audio/Video',
        desc: 'Концерты, музшоу, выступления',
      },
      ...
      { id: '255', cat: 'PC/Games', desc: 'Горячие новинки (License)' },
      {
        id: '629',
        cat: 'PC/Games',
        desc: 'Горячие новинки (Repack / Rip)',
      },
      ...
      { id: '458', cat: 'PC/Games', desc: 'Казуальные игры' },
      {
        id: '142',
        cat: 'PC/Games',
        desc: 'Старые игры (До 2005-го года)',
      },
      ...
      { id: '666', cat: 'PC/0day', desc: 'Сборки Windows все в одном' },
      {
        id: '462',
        cat: 'PC/0day',
        desc: 'Сборки Windows  10 / 8.1 / 8 / 7 / Vista',
      },
      ...
      { id: '611', cat: 'Audio/Audiobook', desc: 'Аудиокниги' },
      {
        id: '612',
        cat: 'Audio/Audiobook',
        desc: 'Научно-образовательные произведения',
      },
      {
        id: '613',
        cat: 'Audio/Audiobook',
        desc: 'Фантастика, мистика, детектив, юмор',
      },
      {
        id: '614',
        cat: 'Audio/Audiobook',
      ...
      },
      {
        id: '207',
        cat: 'PC/Phone-Other',
        desc: 'Темы для мобильных и КПК',
      },
      {
        id: '70',
        cat: 'PC/Phone-Other',
        desc: 'Видео для мобильных и КПК',
      },
      {
        id: '183',
        cat: 'PC/Phone-Other',
        desc: 'Игры для мобильных и КПК',
      },
      {
        id: '182',
        cat: 'PC/Phone-Other',
        desc: 'Картинки для мобильных и КПК',
      },
      {
        id: '184',
        cat: 'PC/Phone-Other',
        desc: 'Софт для мобильных и КПК',
      },
      {
        id: '181',
        cat: 'PC/Phone-Other',
        desc: 'Мелодии для мобильных и КПК',
      },
      {
        id: '185',
        cat: 'PC/Phone-Other',
        desc: 'Прошивки для мобильных и КПК',
      },
      {
        id: '98',
        cat: 'PC/Phone-Other',
        desc: 'Системы навигации и карты для мобильных и КПК',
      },
      { id: '516', cat: 'PC/Phone-IOS', desc: 'Apple' },
      {
        id: '518',
        cat: 'PC/Phone-IOS',
        desc: 'Аудио для iPhone, iPod, iPad',
      },
      {
        id: '519',
        cat: 'PC/Phone-IOS',
        desc: 'Видео для iPhone, iPod, iPad',
      },
      {
        id: '520',
        cat: 'PC/Phone-IOS',
        desc: 'Игры для iPhone, iPod, iPad',
      },
      {
        id: '521',
        cat: 'PC/Phone-IOS',
        desc: 'Софт для iPhone, iPod, iPad',
      },
      {
        id: '522',
        cat: 'PC/Phone-IOS',
        desc: 'Другое для iPhone, iPod, iPad',
      },
  ...
  login: {
    ...
    error: [{ selector: 'div#authError:contains("Неправильный")' }],
    test: { path: '/', selector: 'a[href^="/auth/logout?s="]' },
  },
  search: {
    paths: [
      {
        path:
          'find/{{ range .Categories }}{{.}},{{end}}/{{ .Keywords }}/all/{{ .Config.type }}/{{ .Config.sort }}/search//all/1',
        method: 'post',
      },
    ],
    keywordsfilters: [
    ...
    fields: {
      ...
      title: {
        ...
        filters: [
          ...
          },
          {
            name: 're_replace',
            args: [
              '(.*)[CСcс]езон\\s*(\\d+)\\s*[Ээ]пизоды с\\s*(\\d+)\\s*по\\s*(\\d+)(.*)',
              '$1 S$2E$3-$4 rus $5',
            ],
          },
          {
      ...
      download: {
        selector: 'a[href^="/torrent/"]',
        attribute: 'href',
        filters: [{ name: 'replace', args: ['/torrent/', '/download/'] }],
      },
      date: {
