  ...
  caps: {
    categorymappings: [
      { id: '48', cat: 'Other', desc: 'Форум Региональные встречи' },
      {
        id: '925',
        cat: 'Other',
        desc: 'Форум-Трекер: Клубные таланты Авторские релизы',
      },
      {
        id: '872',
        cat: 'Other',
        desc: 'Форум-Трекер: Клубные таланты Архив',
      },
      ...
      { id: '729', cat: 'TV', desc: ' |- Развивающее Видео для детей' },
      {
        id: '731',
        cat: 'TV',
        desc: ' |- Отечественные Фильмы для детей',
      },
      { id: '733', cat: 'TV', desc: ' |- Зарубежные Фильмы для детей' },
      {
        id: '730',
        cat: 'TV',
        desc: ' |- Отечественные Мультфильмы для детей',
      },
      {
        id: '732',
        cat: 'TV',
        desc: ' |- Зарубежные Мультфильмы для детей',
      },
      {
        id: '230',
        cat: 'TV',
        desc: ' |- Отечественные Мультфильмы (HD*Rip/LQ, DVDRip, SATRip,...',
      },
      {
        id: '659',
        cat: 'TV',
        desc: ' |- Отечественные Мультфильмы (HD, UHD, UHD-LQ, DVD, Сборники)',
      },
      { id: '658', cat: 'TV', desc: ' |- Отечественные Мультсериалы' },
      {
        id: '231',
        cat: 'TV',
        desc: ' |- Зарубежные Мультфильмы (HD*Rip/LQ, DVDRip, SATRip, VHSRip)',
      },
      {
        id: '660',
        cat: 'TV',
        desc: ' |- Зарубежные Мультфильмы (DVD, Сборники)',
      },
      {
        id: '661',
        cat: 'TV',
        desc: ' |- Зарубежные Мультфильмы (HD, UHD, UHD-LQ)',
      },
      ...
      { id: '742', cat: 'Other', desc: ' |- Музыка и песни для детей' },
      {
        id: '735',
        cat: 'Other',
        desc: ' |- Аудиокниги для детей и родителей',
      },
      {
        id: '738',
        cat: 'Other',
        desc: ' |- Образование, обучение и развитие детей',
      },
      {
        id: '967',
        cat: 'Other',
        desc: ' |- Логопедия, Психология, Педиатрия',
      },
      {
        id: '907',
        cat: 'Other',
        desc: ' |- Журналы для детей и родителей',
      },
      ...
      { id: '1109', cat: 'Other', desc: ' |- Энциклопедии для детей' },
      {
        id: '736',
        cat: 'Other',
        desc: ' |- Мультимедийные материалы для родителей',
      },
      {
        id: '737',
        cat: 'Other',
        desc: ' |- Мультимедийные материалы для детей',
      },
      {
        id: '898',
        cat: 'Other',
        desc: ' |- Рабочие тетради, прописи и разукрашки',
      },
      ...
      { id: '973', cat: 'Other', desc: ' |- Изобразительное искусство' },
      {
        id: '960',
        cat: 'Other',
        desc: ' |- Прочие материалы для детей и родителей',
      },
      ...
      },
      {
        id: '1310',
        cat: 'Movies',
        desc: ' |- Старые Отечественные Фильмы (DVD)',
      },
      {
        id: '909',
        cat: 'Movies',
      ...
      { id: '1311', cat: 'Movies', desc: 'Коллекции / *логии' },
      {
        id: '1313',
        cat: 'Movies',
        desc: ' |- Зарубежное кино (коллекции / *логии)',
      },
      {
        id: '1312',
        cat: 'Movies',
        desc: ' |- Отечественное кино (коллекции / *логии)',
      },
      ...
      },
      {
        id: '722',
        cat: 'TV',
        desc: ' |- Чертова служба в госпитале МЭШ / M*A*S*H',
      },
      ...
      { id: '466', cat: 'Books', desc: ' |- Бизнес' },
      {
        id: '1319',
        cat: 'Books',
        desc: ' |- Иностранные языки, обуч.видео',
      },
      ...
      { id: '324', cat: 'Audio', desc: 'Electronic' },
      {
        id: '1327',
        cat: 'Audio',
        desc: ' |- Psybient, Psychill, Psydub (Lossless)',
      },
      {
        id: '1328',
        cat: 'Audio',
        desc: ' |- Psybient, Psychill, Psydub',
      },
      {
        id: '1325',
        cat: 'Audio',
        desc: ' |- Downtempo, Trip-Hop, Lounge (Lossless)',
      },
      {
        id: '1326',
        cat: 'Audio',
        desc: ' |- Downtempo, Trip-Hop, Lounge',
      },
      {
        id: '1323',
        cat: 'Audio',
      ...
      },
      {
        id: '1324',
        cat: 'Audio',
        desc: ' |- Ambient, Experimental, Modern Classical',
      },
      ...
      { id: '90', cat: 'Other', desc: 'Архив торрентов' },
      { id: '892', cat: 'Other', desc: '|- Архив Мультфильмов' },
      { id: '91', cat: 'Other', desc: ' |- Архив Видео' },
      {
        id: '150',
        cat: 'Other',
        desc: ' |- Архив неактуальных Экранок и любого видео с Рекламой',
      },
      {
        id: '668',
        cat: 'Other',
        desc: ' |- Архив Классики, Старого кино, Артхаус',
      },
