...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '22', cat: 'XXX', desc: '   молодые (young)' },
      {
        id: '24',
        cat: 'XXX',
        desc: '   минет / куннилингус / орал (blowjob / cunnilingus / screaming)',
      },
  ...
  search: {
    ...
    fields: {
      ...
      title: { selector: 'div.news_text > a' },
      details: { selector: 'div.news_text > a', attribute: 'href' },
      download: { selector: 'div.news_text > a', attribute: 'href' },
      banner: {
