...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://the-resurrection.pro/'],
  caps: {
    categorymappings: [
      ...
      { id: '20', cat: 'Audio/MP3', 'Packs Mp3': null },
  ...
  search: {
    ...
    rows: {
      selector:
        'table.lista[width="100%"] > tbody > tr:has(a[href^="index.php?page=torrent-details"])',
    },
    fields: {
