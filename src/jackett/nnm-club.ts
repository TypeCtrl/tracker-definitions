...
export const definition: TopLevel = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: 576, cat: 'Other', desc: 'Документалистика и Телепередачи ' },
      {
        id: 590,
        cat: 'Other',
      ...
      { id: 442, cat: 'Other', desc: ' |- Точные и естественные науки ' },
      ...
      { id: 1063, cat: 'Other', desc: ' |- Приключенческая литература ' },
      ...
      { id: 933, cat: 'Other', desc: ' |- Сад, огород, животноводство ' },
