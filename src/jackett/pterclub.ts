...
export const definition: TrackerDefinition = {
  ...
  search: {
    ...
    fields: {
      ...
      size: { selector: 'td.rowfollow:nth-of-type(5)' },
      seeders: { selector: 'td.rowfollow:nth-of-type(6)' },
      leechers: { selector: 'td.rowfollow.rowfollow:nth-of-type(7)' },
      grabs: { selector: 'td.rowfollow:nth-of-type(8)' },
