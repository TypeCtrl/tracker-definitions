...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    },
    {
      ...
      default: 3,
      options: { '1': 'title', '3': 'created', '4': 'size', '6': 'seeders' },
    },
    {
      name: 'type',
      type: 'select',
  ...
  search: {
    paths: [
      { path: 'browse.php', categories: ['!', 60, 27] },
      { path: 'browseadult.php', categories: [60, 27] },
    ],
    inputs: {
    ...
    rows: { selector: 'tbody > tr:has(a[href^="download.php"])' },
    fields: {
      category: {
