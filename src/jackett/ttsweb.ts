...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '13', cat: 'Console/Xbox360', desc: 'Games Xbox360' },
  ...
  search: {
    ...
    rows: {
      selector:
        'table[border="1"][cellspacing="0"][cellpadding="5"] tr:has(a[href^="details.php?id="]):has(a[href^="browse.php?cat="])',
    ...
    fields: {
      ...
      uploadvolumefactor: {
        case: { 'img[src="./pic/icons2/doubleseed.gif"]': 2, '*': 1 },
      },
      minimumratio: { text: 1 },
