...
export const definition: TrackerDefinition = {
  ...
  search: {
    ...
    rows: {
      selector:
        'table[width="852"] > tbody > tr:has(a[href^="download.php?id="]){{ if .Config.freeleech }}:has(a#free-btn){{ else }}{{ end }}',
    },
    fields: {
      category: {
      ...
      uploadvolumefactor: { case: { 'a#double-btn': 2, '*': 1 } },
      minimumratio: { text: 1 },
