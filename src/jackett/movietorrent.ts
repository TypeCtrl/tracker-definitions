...
export const definition: TrackerDefinition = {
  ...
  name: 'MovieTorrent',
  description:
    'MovieTorrent is a Public site for Bollywood, Hollywood, Hindi Dubbed, Tamil , Punjabi, Pakistani MOVIES',
  language: 'en-US',
  type: 'public',
  encoding: 'UTF-8',
  links: ['https://movietorrent.co/'],
  caps: {
    categorymappings: [
  ...
  search: {
    ...
    fields: {
      ...
      title: {
        selector: 'h2',
        filters: [
          { name: 'replace', args: ['Full Movie ', ''] },
          { name: 'replace', args: ['Torrent Magnet ', ''] },
          { name: 'replace', args: ['Download ', ''] },
        ],
      },
      details: { selector: 'h2 > a', attribute: 'href' },
      download: { selector: 'h2 > a', attribute: 'href' },
      poster: { selector: 'a[data-src]', attribute: 'data-src' },
