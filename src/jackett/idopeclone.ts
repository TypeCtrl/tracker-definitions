...
export const definition: TrackerDefinition = {
  ...
  search: {
    ...
    fields: {
      title: { selector: 'div.opt-text-w3layouts a' },
      details: {
      ...
      category: {
        ...
        filters: [{ name: 'replace', args: ['/browse/', ''] }],
      },
      ...
      size: {
        ...
        filters: [{ name: 'replace', args: ['Size: ', ''] }],
      },
      seeders: {
        selector: 'div.seedbar span:nth-child(1)',
        filters: [{ name: 'replace', args: ['Seed: ', ''] }],
      },
      leechers: {
        selector: 'div.seedbar span:nth-child(2)',
        filters: [{ name: 'replace', args: ['Leech: ', ''] }],
      },
