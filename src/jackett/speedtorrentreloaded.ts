...
export const definition: TopLevel = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: 125, cat: 'PC/0day', desc: 'Software: Windows' },
      {
        id: 129,
        cat: 'PC/Phone-Other',
        desc: 'Software: Handy / Navi / Sonst',
      },
  ...
  search: {
    ...
    fields: {
      ...
      files: {
        selector:
          'td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(1) > b:nth-child(2)',
      },
      grabs: {
        selector:
          'td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(3) > b:nth-child(1)',
      },
      size: {
        selector:
      ...
      seeders: {
        selector:
          'td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(2) > b:nth-child(1)',
      },
      leechers: {
        selector:
