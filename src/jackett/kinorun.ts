...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    { name: 'password', type: 'password', label: 'Password' },
    {
      ...
      label: 'IP Filtering',
      default:
        'Kinorun allows only certain IP addressess. The error <b>403 Forbidden: Parse error</b> means your IP was not accepted.',
    },
    {
      name: 'sort',
      type: 'select',
  ...
  login: {
    ...
    error: [{ selector: 'td.embedded:has(div.error)' }, { selector: 'title:contains("403")' }],
