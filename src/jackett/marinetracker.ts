...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      },
      {
        id: '195',
        cat: 'Books',
        desc: 'Shipbuilding & Shiprepairing-Turnary',
      },
      ...
      { id: '6', cat: 'PC', desc: 'Maritime Software' },
      {
        id: '211',
        cat: 'PC',
        desc: 'Maritime Software-Navigation soft & Charts',
      },
      {
        id: '19',
        cat: 'PC',
        desc: 'Maritime Software-Training software',
      },
      { id: '13', cat: 'PC', desc: 'Maritime Software-Marine Tests' },
      {
        id: '14',
        cat: 'PC',
        desc: 'Maritime Software-Maritime Simulators',
      },
      ...
      { id: '21', cat: 'Books', desc: "Deckofficer's Library" },
      {
        id: '283',
        cat: 'Books',
        desc: "Deckofficer's Library-Radar at sea",
      },
      {
        id: '114',
        cat: 'Books',
        desc: "Deckofficer's Library-Watch keeping",
      },
      {
        id: '115',
        cat: 'Books',
        desc: "Deckofficer's Library-Keeping the ship documentation",
      },
      {
        id: '32',
        cat: 'Books',
        desc: "Deckofficer's Library-Cargo operations",
      },
      {
        id: '34',
        cat: 'Books',
        desc: "Deckofficer's Library-Navigation",
      },
      {
        id: '35',
        cat: 'Books',
        desc: "Deckofficer's Library-Ship handling",
      },
      {
        id: '36',
        cat: 'Books',
        desc: "Deckofficer's Library-Technical equipment of navigation",
      },
      {
        id: '95',
        cat: 'Books',
        desc: "Deckofficer's Library-Hydrometeorology",
      },
      {
        id: '100',
        cat: 'Books',
        desc: "Deckofficer's Library-Ship Theory",
      },
      {
        id: '110',
        cat: 'Books',
        desc: "Deckofficer's Library-Astronomy",
      },
      {
        id: '94',
        cat: 'Books',
        desc: "Deckofficer's Library-Nautical charts, tables, sailing directions",
      },
      {
        id: '116',
        cat: 'Books',
        desc: "Deckofficer's Library-Global Maritime Distress and Safety System (GMDSS)",
      },
      {
        id: '192',
        cat: 'Books',
      ...
      { id: '8', cat: 'Movies', desc: 'Video for Seamen' },
      {
        id: '234',
        cat: 'Movies',
        desc: 'Video for Seamen-Video for Deck Officers',
      },
      {
        id: '233',
        cat: 'Movies',
        desc: 'Video for Seamen-Video for Marine Engineers',
      },
      ...
      { id: '102', cat: 'Books', desc: "Marine Engineer's Library" },
      {
        id: '316',
        cat: 'Books',
        desc: "Marine Engineer's Library-Marine Fuels & Lubricants",
      },
      {
        id: '28',
        cat: 'Books',
        desc: "Marine Engineer's Library-Ship's systems and mechanisms\"",
      },
      {
        id: '22',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Daihatsu"',
      },
      {
        id: '164',
        cat: 'Books',
        desc: "Marine Engineer's Library-Operation of ship's power plants\"",
      },
      {
        id: '199',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Ship Propulsion"',
      },
      {
        id: '176',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Marine refrigeration plants"',
      },
      {
        id: '175',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Marine boilers"',
      },
      {
        id: '173',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-MAK & Caterpillar"',
      },
      {
        id: '166',
        cat: 'Books',
        desc: "Marine Engineer's Library-Ship's steam and gas turbines\"",
      },
      {
        id: '134',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Marine Pumps"',
      },
      {
        id: '108',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Hydraulics"',
      },
      {
        id: '16',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-MAN B&W"',
      },
      {
        id: '17',
        cat: 'Books',
        desc: 'Marine Engineer\'s Library-Wärtsilä & Sulzer"',
      },
      ...
      { id: '10', cat: 'Books', desc: 'English for seamen' },
      {
        id: '266',
        cat: 'Books',
        desc: 'English for seamen-English for Deck Officers',
      },
      {
        id: '267',
        cat: 'Books',
        desc: 'English for seamen-English for Marine Engineers',
      },
      {
        id: '268',
        cat: 'Books',
        desc: "English for seamen-English for ETO's",
      },
      {
        id: '269',
        cat: 'Books',
        desc: 'English for seamen-English for Shipbuilders',
      },
      {
        id: '270',
        cat: 'Books',
        desc: 'English for seamen-RU↔EN dictionaries & phrasebooks',
      },
      {
        id: '271',
        cat: 'Books',
        desc: 'English for seamen-Business English and Correspondence',
      },
      { id: '205', cat: 'Books', desc: 'General english' },
      {
        id: '101',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library",
      },
      {
        id: '29',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Marine Electronics",
      },
      {
        id: '103',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Ship's automatics",
      },
      {
        id: '104',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Electrical machines",
      },
      {
        id: '210',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Programmable Logic Controllers (PLC)",
      },
      {
        id: '172',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Incinerators",
      },
      {
        id: '167',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Cranes",
      },
      {
        id: '107',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-ETO Handbooks",
      },
      {
        id: '105',
        cat: 'Books',
        desc: "Electrical Technical Officer's Library-Sources of electricity",
      },
      {
        id: '37',
        cat: 'Books',
        desc: 'Organization and management of maritime transport',
      },
      { id: '11', cat: 'Books', desc: 'Section for cadets' },
      {
        id: '285',
        cat: 'Books',
        desc: 'Section for cadets-Encyclopedias and atlases',
      },
      {
        id: '265',
        cat: 'Books',
        desc: 'Section for cadets-Marine dictionaries and glossaries RU↔RU/EN↔EN',
      },
      ...
      { id: '39', cat: 'Books', desc: 'Purpose-built ships' },
      {
        id: '51',
        cat: 'Books',
        desc: 'Purpose-built ships-Oil & Chemical Tankers',
      },
      {
        id: '52',
        cat: 'Books',
        desc: 'Purpose-built ships-Dry cargo vessels',
      },
      { id: '250', cat: 'Books', desc: 'Purpose-built ships-LNG  LPG' },
      {
        id: '284',
        cat: 'Books',
        desc: 'Purpose-built ships-Nuclear powered ships',
      },
      {
        id: '54',
        cat: 'Books',
        desc: 'Purpose-built ships-Passenger ships',
      },
      {
        id: '248',
        cat: 'Books',
        desc: 'Purpose-built ships-Fishing vessels',
      },
      ...
      },
      {
        id: '237',
        cat: 'Books',
        desc: 'Yachting, sailing, boating-Yachting, sailing videos',
      },
      {
        id: '257',
        cat: 'Books',
        desc: 'Yachting, sailing, boating-Motor Boat & Yachting magazines',
      },
      {
        id: '253',
        cat: 'Books',
        desc: 'Yachting, sailing, boating-Seamanship practice',
      },
      {
        id: '254',
        cat: 'Books',
      ...
      },
      {
        id: '256',
        cat: 'Books',
        desc: 'Yachting, sailing, boating-Rigging, knots',
      },
      {
        id: '252',
        cat: 'Books',
        desc: 'Yachting, sailing, boating-Projects, design, construction',
      },
      ...
      { id: '177', cat: 'Books', desc: 'Shipmodeling' },
      {
        id: '293',
        cat: 'Books',
        desc: 'Shipmodeling-Radio controlled models',
      },
      {
        id: '292',
        cat: 'Books',
        desc: 'Shipmodeling-Marine Modelling Magazines',
      },
      {
        id: '291',
        cat: 'Books',
        desc: 'Shipmodeling-Drawings and models of ships (CAD, 3D)',
      },
      {
        id: '290',
        cat: 'Books',
        desc: 'Shipmodeling-Reference Material',
      },
      ...
      { id: '282', cat: 'Books', desc: 'Marine History-Fleets history' },
      {
        id: '281',
        cat: 'Books',
        desc: 'Marine History-History of Merchant Marine',
      },
      ...
      { id: '278', cat: 'Books', desc: 'Marine History-Warships' },
      {
        id: '259',
        cat: 'Books',
        desc: 'Marine History-Shipbuilding history',
      },
      { id: '277', cat: 'Books', desc: 'Marine History-Wars at Sea' },
      {
        id: '276',
        cat: 'Books',
        desc: 'Marine History-War at sea (World War I)',
      },
      {
        id: '261',
        cat: 'Books',
        desc: 'Marine History-War at sea (World War II)',
      },
      {
        id: '262',
        cat: 'Books',
        desc: 'Marine History-The history of sailing ships',
      },
      {
        id: '273',
        cat: 'Books',
        desc: 'Marine History-History of Seafaring',
      },
      {
        id: '275',
        cat: 'Books',
        desc: 'Marine History-Accidents and disasters at sea',
      },
      {
        id: '264',
        cat: 'Books',
        desc: 'Marine History-Marine cartography',
      },
  ...
  login: {
    ...
    error: [{ selector: 'div#error_fon' }],
    test: { path: '/', selector: 'a[href^="/./login.php?logout="]' },
  },
  search: {
    ...
    fields: {
      ...
      description: { selector: 'td span.iconDL' },
