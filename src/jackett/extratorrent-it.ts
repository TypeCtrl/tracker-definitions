...
export const definition: TrackerDefinition = {
  ...
  description:
    'ExtraTorrent.it is a Public tracker, a popular alternative to the original ET site, providing Movie / TV / General magnets',
  language: 'en-US',
  type: 'public',
  encoding: 'UTF-8',
  links: ['https://extratorrents.it/', 'https://extratorrent.unblockit.club/', 'https://extratorrent.nocensor.space/'],
  legacylinks: [
  ...
  caps: {
    categorymappings: [
      ...
      { id: '99', cat: 'TV/Anime', desc: 'Anime - Anime - Other' },
      {
        id: '86',
        cat: 'TV/Anime',
        desc: 'Anime - Battle Programer Shirase',
      },
      { id: '87', cat: 'TV/Anime', desc: 'Anime - Big O' },
      {
        id: '960',
        cat: 'TV/Anime',
        desc: 'Anime - Binan Koukou Chikyuu Bouei-bu Love',
      },
      ...
      { id: '93', cat: 'TV/Anime', desc: 'Anime - Full Metal Alchemist' },
      {
        id: '95',
        cat: 'TV/Anime',
        desc: 'Anime - Ghost In The Shell SAC',
      },
      ...
      { id: '145', cat: 'TV/Anime', desc: 'Anime - Hunter X Hunter' },
      {
        id: '949',
        cat: 'TV/Anime',
        desc: 'Anime - Inou Battle wa Nichijou-kei no Naka de',
      },
      ...
      { id: '100', cat: 'TV/Anime', desc: 'Anime - Onegai Twins' },
      {
        id: '523',
        cat: 'TV/Anime',
        desc: 'Anime - Ouran High School Host Club',
      },
      ...
      { id: '997', cat: 'TV/Anime', desc: 'Anime - Spider-man' },
      {
        id: '106',
        cat: 'TV/Anime',
        desc: 'Anime - Stellvia of the Universe',
      },
      ...
      { id: '58', cat: 'Audio', desc: 'Music - Classic' },
      {
        id: '515',
        cat: 'Audio',
        desc: 'Music - Compilation/Various Artists (VA)',
      },
      ...
      { id: '63', cat: 'Audio', desc: 'Music - Hardcore' },
      {
        id: '78',
        cat: 'Audio',
        desc: 'Music - HardHouse/Old School Radio Mixes',
      },
      ...
      { id: '522', cat: 'Audio', desc: 'Music - Non-English' },
      {
        id: '507',
        cat: 'Audio',
        desc: "Music - Now That's What I Call Music",
      },
      ...
      { id: '891', cat: 'TV', desc: 'TV - Bates Motel' },
      {
        id: '802',
        cat: 'TV',
        desc: 'TV - Batman The Brave and The Bold',
      },
      ...
      { id: '606', cat: 'TV', desc: 'TV - Dollhouse' },
      {
        id: '839',
        cat: 'TV',
        desc: 'TV - Dont Trust the Bitch in Apartment',
      },
      ...
      { id: '571', cat: 'TV', desc: 'TV - Extant' },
      {
        id: '840',
        cat: 'TV',
        desc: 'TV - Fact or Faked Paranormal Files',
      },
      ...
      { id: '568', cat: 'TV', desc: 'TV - How Its Made' },
      {
        id: '893',
        cat: 'TV',
        desc: 'TV - How to Live with Your Parents',
      },
      ...
      { id: '817', cat: 'TV', desc: 'TV - Ironside' },
      {
        id: '772',
        cat: 'TV',
        desc: 'TV - Its Always Sunny in Philadelphia',
      },
      ...
      { id: '763', cat: 'TV', desc: 'TV - Jersey Shore' },
      {
        id: '177',
        cat: 'TV',
        desc: 'TV - Joe Rogan Questions Everything',
      },
      ...
      { id: '867', cat: 'TV', desc: 'TV - Last Resort' },
      {
        id: '200',
        cat: 'TV',
        desc: "TV - Late Night with Conan O'Brien",
      },
      ...
      { id: '662', cat: 'TV', desc: 'TV - Man vs Wild' },
      {
        id: '759',
        cat: 'TV',
        desc: 'TV - Marvels Agents of S.H.I.E.L.D',
      },
      ...
      { id: '792', cat: 'TV', desc: 'TV - My Ghost Story' },
      {
        id: '999',
        cat: 'TV',
        desc: 'TV - My Little Pony - Friendship is Magic',
      },
      ...
      { id: '940', cat: 'TV', desc: 'TV - Naked And Afraid' },
      {
        id: '203',
        cat: 'TV',
        desc: 'TV - NASA 50 Years Of Space Exploration',
      },
      { id: '899', cat: 'TV', desc: 'TV - Nashville' },
      {
        id: '636',
        cat: 'TV/Documentary',
        desc: 'TV - National Geographic',
      },
      ...
      { id: '936', cat: 'TV', desc: 'TV - Ray Donovan' },
      {
        id: '594',
        cat: 'TV',
        desc: 'TV - Ray Mears Northern Wilderness',
      },
      ...
      { id: '139', cat: 'TV', desc: 'TV - Star-Trek Enterprise' },
      {
        id: '144',
        cat: 'TV',
        desc: 'TV - Star-Trek The Next Generation',
      },
      ...
      { id: '857', cat: 'TV', desc: 'TV - Strike Back' },
      {
        id: '528',
        cat: 'TV',
        desc: 'TV - Studio 60 on the Sunset Strip',
      },
      ...
      { id: '168', cat: 'TV', desc: 'TV - The 4400' },
      {
        id: '300',
        cat: 'TV',
        desc: 'TV - The Adventures of Sherlock Holmes',
      },
      ...
      { id: '664', cat: 'TV', desc: 'TV - The Sci Fi Guys' },
      {
        id: '393',
        cat: 'TV',
        desc: 'TV - The Secret Adventures of Jules Verne',
      },
      { id: '786', cat: 'TV', desc: 'TV - The Secret Circle' },
      {
        id: '668',
        cat: 'TV',
        desc: 'TV - The Secret Life of the American Teenager',
      },
      ...
      { id: '1018', cat: 'Console/Xbox360', desc: 'Games - Xbox 360' },
      ...
      { id: '465', cat: 'Books/Mags', desc: 'Books - Magazines' },
      {
        id: '1000',
        cat: 'Books',
        desc: 'Books - Sexual Fitness and Education',
      },
      ...
      { id: '416', cat: 'PC/Mobile-Other', desc: 'Mobile' },
      {
        id: '752',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Games for Android',
      },
      {
        id: '746',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Games for Apple iPod, iPod Touch, iPad, iPhone',
      },
      {
        id: '745',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Games for Java',
      },
      {
        id: '744',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Games for Symbian',
      },
      {
        id: '743',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Games for Windows Mobile',
      },
      ...
      { id: '554', cat: 'PC/Mobile-Other', desc: 'Mobile - Other' },
      {
        id: '748',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Software - Other',
      },
      {
        id: '972',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Software for Android',
      },
      {
        id: '749',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Software for Apple iPad, iPhone, iPod Touch',
      },
      {
        id: '747',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Software for Windows Mobile',
      },
      ...
      { id: '417', cat: 'PC/Mobile-Other', desc: 'Mobile - Video' },
      {
        id: '750',
        cat: 'PC/Mobile-Other',
        desc: 'Mobile - Video for Apple iPad, iPhone, iPod Touch',
      },
    ],
    modes: {
      search: ['q'],
