...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    { name: 'secure_code', type: 'password', label: 'Secure Code' },
  ],
  login: {
    path: 'login.php',
    method: 'post',
  ...
  search: {
    ...
    rows: { selector: 'div.x264_tfiles_wrapper_go' },
    fields: {
      category: {
      ...
      title: { selector: 'div.x264_tfiles_wrapper_name a' },
      details: {
      ...
      files: {
        selector: 'div.x264_tfiles_wrapper_files',
        filters: [{ name: 'regexp', args: 'mit (\\d+)' }],
      },
      seeders: { selector: 'div.x264_tfiles_wrapper_sl font:nth-child(1)' },
      leechers: {
