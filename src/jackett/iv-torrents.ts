...
export const definition: TrackerDefinition = {
  ...
  type: 'semi-private',
  encoding: 'UTF-8',
  links: ['http://iv-torrents.com/'],
  legacylinks: ['https://iv-torrents.ru/', 'https://iv-torrents.com/'],
  caps: {
    categorymappings: [
      ...
      { id: '302', cat: 'Movies', desc: ' |- Правила раздела' },
      {
        id: '134',
        cat: 'Movies',
        desc: ' |- Обсуждение ожидаемого кино',
      },
      ...
      { id: '43', cat: 'Movies', desc: ' |- Новые релизы' },
      {
        id: '66',
        cat: 'Movies',
        desc: ' |- Зарубежные фильмы (Новинки)',
      },
      { id: '67', cat: 'Movies', desc: ' |- Зарубежные фильмы' },
      {
        id: '68',
        cat: 'Movies',
        desc: ' |- Отечественные фильмы (Новинки)',
      },
      { id: '69', cat: 'Movies', desc: ' |- Отечественные фильмы' },
      {
        id: '128',
        cat: 'Movies',
        desc: ' |- Классика зарубежного кино (фильмы вышедшие до 1980 года)',
      },
      {
        id: '129',
        cat: 'Movies',
        desc: ' |- Классика отечественного кино (фильмы вышедшие до ...',
      },
      ...
      { id: '735', cat: 'Movies/HD', desc: ' |- 60fps' },
      {
        id: '50',
        cat: 'Movies/HD',
        desc: ' |- Зарубежные фильмы HD (Новинки)',
      },
      {
        id: '51',
        cat: 'Movies/HD',
        desc: ' |- Наши фильмы HD (Новинки)',
      },
      {
        id: '52',
        cat: 'Movies/HD',
        desc: ' |- Зарубежные фильмы HD (BD и Remux)',
      },
      {
        id: '54',
        cat: 'Movies/HD',
        desc: ' |- Наши фильмы HD (BD и Remux)',
      },
      { id: '736', cat: 'Movies/HD', desc: ' |- UHD Video' },
      {
        id: '53',
        cat: 'Movies/HD',
        desc: ' |- Зарубежные фильмы (Рипы 720p и 1080p)',
      },
      {
        id: '55',
        cat: 'Movies/HD',
        desc: ' |- Наши фильмы (Рипы 720p и 1080p)',
      },
      { id: '516', cat: 'Movies/HD', desc: ' |- Антологии' },
      {
        id: '686',
        cat: 'Movies/HD',
        desc: ' |- HD фильмы WEB-DLRip, HDTVRip (720 и 1080)',
      },
      {
        id: '681',
        cat: 'Movies/HD',
      ...
      { id: '57', cat: 'Movies/DVD', desc: ' |- Наши фильмы DVD ' },
      {
        id: '58',
        cat: 'Movies/DVD',
        desc: ' |- Зарубежные мультфильмы DVD ',
      },
      ...
      { id: '340', cat: 'Movies/3D', desc: ' |- 3D Зарубежные фильмы' },
      {
        id: '341',
        cat: 'Movies/3D',
        desc: ' |- 3D Отечественные фильмы',
      },
      {
        id: '343',
        cat: 'Movies/3D',
        desc: ' |- 3D Зарубежные мультфильмы',
      },
      {
        id: '344',
        cat: 'Movies/3D',
        desc: ' |- 3D отечественные мультфильмы',
      },
      {
        id: '342',
        cat: 'Movies/3D',
      ...
      { id: '345', cat: 'Movies/3D', desc: ' |- 3D Спорт' },
      {
        id: '400',
        cat: 'TV/Documentary',
        desc: 'Документальные фильмы, Научно-познавательные фильмы',
      },
      ...
      { id: '410', cat: 'TV/Documentary', desc: ' |- О рыбалке и охоте' },
      {
        id: '408',
        cat: 'TV/Documentary',
        desc: ' |- Криминальные документальные фильмы',
      },
      {
        id: '402',
        cat: 'TV/Documentary',
        desc: ' |- Документальные научно-познавательные',
      },
      {
        id: '520',
        cat: 'TV/Documentary',
      ...
      { id: '519', cat: 'TV/Documentary', desc: ' |- Космос' },
      {
        id: '407',
        cat: 'TV/Documentary',
        desc: ' |- Документальные фильмы о военной технике',
      },
      {
        id: '409',
        cat: 'TV/Documentary',
        desc: ' |- Информационные, политические и аналитические телепередачи',
      },
      {
        id: '403',
        cat: 'TV/Documentary',
        desc: ' |- Документальные фильмы о трагедиях и катаклизмах',
      },
      { id: '482', cat: 'TV/Documentary', desc: ' |- История' },
      {
        id: '411',
        cat: 'TV/Documentary',
        desc: ' |- Другое документальное кино',
      },
      {
        id: '418',
        cat: 'Movies',
        desc: 'Фильмы в авторском одноголосным переводе',
      },
      ...
      { id: '499', cat: 'Movies', desc: ' |- Сербин, Юрий Владимирович' },
      {
        id: '419',
        cat: 'Movies',
        desc: ' |- Пучков Дмитрий Юрьевич [Гоблин / Goblin]',
      },
      {
        id: '420',
        cat: 'Movies',
        desc: ' |- Володарский Леонид Вениаминович',
      },
      { id: '527', cat: 'Movies', desc: ' |- Новые релизы' },
      {
        id: '528',
        cat: 'Movies',
        desc: ' |- Фильмографии зарубежных актёров',
      },
      {
        id: '529',
        cat: 'Movies',
        desc: ' |- Фильмографии отечественных актёров',
      },
      ...
      { id: '567', cat: 'XXX', desc: ' |- Эротика' },
      {
        id: '568',
        cat: 'XXX',
        desc: ' |- Эротика HD (720p/1080p/1080i)',
      },
      { id: '569', cat: 'XXX', desc: ' |- Мульты' },
      {
        id: '570',
        cat: 'XXX',
        desc: ' |- Документальные фильмы/Обучающее видео',
      },
      ...
      { id: '572', cat: 'XXX', desc: ' |- Журналы/Книги' },
      {
        id: '573',
        cat: 'XXX',
        desc: ' |- Полнометражные PRON-фильмы (с русским переводом)',
      },
      { id: '574', cat: 'XXX', desc: ' |- Разное' },
      {
        id: '468',
        cat: 'Other',
        desc: 'Видеоуроки и обучающие интерактивные диски',
      },
      ...
      { id: '522', cat: 'Other', desc: ' |- Спорт, Фитнес и аэробика' },
      {
        id: '579',
        cat: 'Other',
        desc: ' |- Беременность, роды, материнство',
      },
      {
        id: '521',
        cat: 'Other',
      ...
      },
      {
        id: '580',
        cat: 'Other',
        desc: ' |- Рыболовство и подводная охота',
      },
      {
        id: '581',
        cat: 'Other',
        desc: ' |- Строительство, ремонт и дизайн',
      },
      {
        id: '523',
        cat: 'Other',
      ...
      { id: '426', cat: 'Other', desc: ' |- Autodesk 3ds Max' },
      { id: '425', cat: 'Other', desc: ' |- Adobe Photoshop' },
      {
        id: '427',
        cat: 'Other',
        desc: ' |- Инженерные и научные программы (видеоуроки)',
      },
      {
        id: '424',
        cat: 'Other',
        desc: ' |- WEB, SMM, SEO, интернет-маркетинг',
      },
      {
        id: '472',
        cat: 'Other',
      ...
      { id: '91', cat: 'Console', desc: ' |- TBS (пошаговые стратегии)' },
      {
        id: '88',
        cat: 'Console',
        desc: ' |- Многопользовательские игры',
      },
      ...
      { id: '114', cat: 'Console/Xbox360', desc: ' |- XBox360 ' },
      {
        id: '674',
        cat: 'Console/Xbox360',
        desc: ' |- XBox360 | Kinect ',
      ...
      { id: '535', cat: 'Console/Xbox360', desc: ' |- XBox360 ' },
      ...
      { id: '284', cat: 'Console', desc: ' |- Трейлеры/Геймплей видео' },
      {
        id: '283',
        cat: 'Console',
        desc: ' |- Различные моды и дополнения к играм',
      },
      ...
      { id: '278', cat: 'Console', desc: ' |- Русификаторы' },
      {
        id: '21',
        cat: 'TV',
        desc: 'Зарубежные мультипликационные фильмы',
      },
      { id: '170', cat: 'TV', desc: ' |- Новые релизы' },
      {
        id: '169',
        cat: 'TV',
        desc: ' |- Зарубежные мультфильмы в идеальном качестве',
      },
      {
        id: '168',
        cat: 'TV',
        desc: ' |- Зарубежные мультфильмы в хорошем качестве',
      },
      {
        id: '167',
        cat: 'TV',
        desc: ' |- Зарубежные мультфильмы в плохом качестве',
      },
      {
        id: '166',
        cat: 'TV',
        desc: ' |- Короткометражная мультипликация (анимация)',
      },
      {
        id: '165',
        cat: 'TV',
        desc: ' |- Сборники зарубежных мультфильмов и сиквелы',
      },
      {
        id: '22',
        cat: 'TV',
        desc: 'Отечественные мультипликационные фильмы',
      },
      { id: '164', cat: 'TV', desc: ' |- Новые релизы' },
      {
        id: '163',
        cat: 'TV',
        desc: ' |- Отечественные мультфильмы в идеальном качестве',
      },
      {
        id: '162',
        cat: 'TV',
        desc: ' |- Отечественные мультфильмы в хорошем качестве',
      },
      {
        id: '161',
        cat: 'TV',
        desc: ' |- Отечественные мультфильмы в плохом качестве',
      },
      {
        id: '160',
        cat: 'TV',
      ...
      },
      {
        id: '159',
        cat: 'TV',
        desc: ' |- Сборники отечественных мультфильмов и сиквелы',
      },
      ...
      { id: '151', cat: 'TV', desc: ' |- Футурама' },
      {
        id: '150',
        cat: 'TV',
        desc: ' |- Другие зарубежные мультсериалы',
      },
      ...
      { id: '147', cat: 'TV', desc: ' |- Маша и медведь' },
      {
        id: '146',
        cat: 'TV',
        desc: ' |- Другие отечественные мультсериалы',
      },
      ...
      { id: '479', cat: 'TV/HD', desc: ' |- Новые релизы' },
      {
        id: '480',
        cat: 'TV/HD',
        desc: ' |- Зарубежные мультфильмы (Рипы 720p и 1080p)',
      },
      {
        id: '481',
        cat: 'TV/HD',
        desc: ' |- Наши мультфильмы (Рипы 720p и 1080p)',
      },
      {
        id: '684',
        cat: 'TV/HD',
        desc: ' |- Зарубежные мультфильмы HD (BD и Remux)',
      },
      {
        id: '685',
        cat: 'TV/HD',
        desc: ' |- Отечественные мультфильмы HD (BD и Remux)',
      },
      ...
      { id: '249', cat: 'TV', desc: ' |- Ментовские войны' },
      {
        id: '247',
        cat: 'TV',
        desc: ' |- Кадетство / Кремлёвские курсанты',
      },
      ...
      },
      {
        id: '538',
        cat: 'TV',
        desc: ' |- Секретные материалы / The X-Files ',
      },
      ...
      },
      {
        id: '542',
        cat: 'TV',
        desc: ' |- Холм одного дерева / One tree hill ',
      },
      {
        id: '543',
        cat: 'TV',
      ...
      { id: '560', cat: 'Other', desc: ' |- Уральские пельмени' },
      {
        id: '296',
        cat: 'Other',
        desc: ' |- Смешное видео (короткометражный формат)',
      },
      {
        id: '295',
        cat: 'Other',
        desc: ' |- Другие юмористические ролики и передачи',
      },
      { id: '185', cat: 'PC', desc: ' |- Новые релизы' },
      {
        id: '184',
        cat: 'PC',
        desc: ' |- Настольные OS, выпущенные до 2001 года (Microsoft Windows...',
      },
      ...
      { id: '216', cat: 'PC', desc: ' |- Драйвера' },
      {
        id: '215',
        cat: 'PC',
        desc: ' |- Изменение интерфейса ОС Windows и скринсейверы',
      },
      {
        id: '214',
        cat: 'PC',
      ...
      },
      {
        id: '213',
        cat: 'PC',
        desc: ' |- Программы для настройки и оптимизации ОС, информаци...',
      },
      ...
      },
      {
        id: '210',
        cat: 'PC',
        desc: ' |- Резервное копирование и программы для защиты информации',
      },
      ...
      { id: '195', cat: 'PC', desc: ' |- Разное' },
      {
        id: '39',
        cat: 'PC',
        desc: 'Системы для бизнеса, офиса, научной и проектной работ...',
      },
      ...
      { id: '221', cat: 'PC', desc: ' |- Прочие справочные системы' },
      {
        id: '220',
        cat: 'PC',
        desc: ' |- Разное (Системы для бизнеса, офиса, научной и проектн...',
      },
      ...
      },
      {
        id: '258',
        cat: 'Audio',
        desc: 'Правила и инструкции раздела Музыка',
      },
      {
        id: '257',
        cat: 'Audio',
        desc: 'Предложения по улучшению раздела Музыка',
      },
      ...
      },
      {
        id: '764',
        cat: 'Audio',
        desc: ' |- Отечественная поп-музыка (сборники) (lossy)',
      },
      ...
      },
      {
        id: '588',
        cat: 'Other',
        desc: ' |- Тюнинг, чиптюнинг, настройка',
      },
      {
        id: '589',
        cat: 'Other',
      ...
      },
      {
        id: '590',
        cat: 'Other',
        desc: ' |- Мультимедийки по ремонту/обслуживанию/эксплуатации ТС',
      },
      ...
      { id: '598', cat: 'Other', desc: ' |- Новые релизы' },
      {
        id: '599',
        cat: 'Other',
        desc: ' |- Документальные/познавательные фильмы',
      },
      ...
      { id: '601', cat: 'Other', desc: ' |- Top Gear/Топ Гир' },
      {
        id: '602',
        cat: 'Other',
        desc: ' |- Тест драйв/Обзоры/Автосалоны',
      },
      ...
      { id: '739', cat: 'Books', desc: 'Иностранные языки для взрослых' },
      {
        id: '751',
        cat: 'Books',
        desc: ' |- Русский язык как иностранный',
      },
      ...
      { id: '744', cat: 'Books', desc: ' |- Немецкий язык' },
      {
        id: '743',
        cat: 'Books',
        desc: ' |- Английский язык (для взрослых)',
      },
      { id: '740', cat: 'Books', desc: 'Иностранные языки для детей' },
      {
        id: '755',
        cat: 'Books',
        desc: ' |- Школьные учебники, ЕГЭ, ОГЭ',
      },
      {
        id: '754',
        cat: 'Books',
        desc: ' |- Восточные языки (для детей)',
      },
      {
        id: '753',
        cat: 'Books',
        desc: ' |- Другие европейские языки (для детей)',
      },
      {
        id: '752',
        cat: 'Books',
      ...
      },
      {
        id: '741',
        cat: 'Books',
        desc: 'удожественная литература (ин.языки)',
      },
      {
        id: '760',
        cat: 'Books',
        desc: ' |- Художественная литература на восточных языках',
      },
      {
        id: '759',
        cat: 'Books',
        desc: ' |- Художественная литература на других европейских языках',
      },
      {
        id: '758',
        cat: 'Books',
      ...
      },
      {
        id: '757',
        cat: 'Books',
        desc: ' |- Художественная литература на французском языке',
      },
      {
        id: '756',
        cat: 'Books',
        desc: ' |- Художественная литература на английском языке',
      },
      {
        id: '742',
        cat: 'Books',
      ...
      },
      {
        id: '763',
        cat: 'Books',
        desc: ' |- Аудиокниги на других иностранных языках',
      },
      {
        id: '762',
        cat: 'Books',
        desc: ' |- Аудиокниги на немецком языке',
      },
      {
        id: '761',
        cat: 'Books',
        desc: ' |- Аудиокниги на английском языке',
      },
      {
        id: '433',
        cat: 'PC/Phone-Other',
        desc: 'Приложения для мобильных телефонов и КПК, КМК',
      },
      ...
      { id: '445', cat: 'PC/Phone-Other', desc: ' |- Windows Mobile ' },
      {
        id: '575',
        cat: 'PC/Phone-Other',
        desc: ' |- Игры для Windows Phone 7,8 ',
      },
      {
        id: '447',
        cat: 'PC/Phone-Other',
      ...
      { id: '610', cat: 'Books', desc: ' |- Новые релизы' },
      {
        id: '611',
        cat: 'Books',
        desc: ' |- Кино, театр, ТВ, мультипликация',
      },
      {
        id: '612',
        cat: 'Books',
        desc: ' |- Рисунок, графический дизайн',
      },
      { id: '613', cat: 'Books', desc: ' |- Фото и видеосъемка' },
      {
        id: '614',
        cat: 'Books',
        desc: ' |- Журналы и газеты (общий раздел)',
      },
      {
        id: '615',
        cat: 'Books',
        desc: ' |- Эзотерика, гадания, магия, фен-шуй',
      },
      ...
      { id: '620', cat: 'Books', desc: ' |- Разное' },
      {
        id: '621',
        cat: 'Books',
        desc: 'Для детей, родителей и учителей',
      },
      { id: '622', cat: 'Books', desc: ' |- Новые релизы' },
      {
        id: '623',
        cat: 'Books',
        desc: ' |- Учебная литература для детского сада и начальной шко...',
      },
      {
        id: '624',
        cat: 'Books',
        desc: ' |- Учебная литература для старших классов (5-11 класс)',
      },
      { id: '625', cat: 'Books', desc: ' |- Учителям и педагогам' },
      {
        id: '626',
        cat: 'Books',
        desc: ' |- Научно-популярная и познавательная литература (для детей)',
      },
      ...
      { id: '628', cat: 'Books', desc: ' |- Воспитание и развитие' },
      {
        id: '629',
        cat: 'Books',
        desc: ' |- Худ. лит-ра для дошкольников и младших классов',
      },
      {
        id: '630',
        cat: 'Books',
        desc: ' |- Худ. лит-ра для средних и старших классов',
      },
      ...
      },
      {
        id: '631',
        cat: 'Books',
        desc: 'Спорт, физическая культура, боевые искусства',
      },
      ...
      { id: '635', cat: 'Books', desc: ' |- Шахматы. Шашки' },
      {
        id: '636',
        cat: 'Books',
        desc: ' |- Физкультура, фитнес, бодибилдинг',
      },
      {
        id: '637',
        cat: 'Books',
        desc: ' |- Боевые искусства, единоборства',
      },
      ...
      { id: '642', cat: 'Books', desc: ' |- Новые релизы' },
      {
        id: '643',
        cat: 'Books',
        desc: ' |- Искусствоведение. Культурология',
      },
      ...
      { id: '654', cat: 'Books', desc: ' |- Финансы' },
      {
        id: '655',
        cat: 'Books',
        desc: ' |- Юридические науки. Право. Криминалистика',
      },
      ...
      { id: '659', cat: 'Books', desc: ' |- Исторические персоны' },
      {
        id: '661',
        cat: 'Books',
        desc: ' |- Альтернативные исторические теории',
      },
      ...
      { id: '663', cat: 'Books', desc: ' |- Средние века' },
      {
        id: '664',
        cat: 'Books',
        desc: ' |- История Нового и Новейшего времени',
      },
      { id: '665', cat: 'Books', desc: ' |- История Востока' },
      {
        id: '666',
        cat: 'Books',
        desc: ' |- История Америки, Австралии, Океании',
      },
      ...
      { id: '669', cat: 'Books', desc: ' |- История стран бывшего СССР' },
      {
        id: '670',
        cat: 'Books',
        desc: ' |- История отдельных стран и регионов',
      },
      { id: '671', cat: 'Books', desc: ' |- Этнография, антропология' },
      {
        id: '672',
        cat: 'Books',
        desc: ' |- Международные отношения. Дипломатия',
      },
      ...
      { id: '639', cat: 'Audio/Audiobook', desc: ' |- Новые релизы' },
      {
        id: '732',
        cat: 'Audio/Audiobook',
        desc: ' |- [Аудио] Российская фантастика, фэнтези, мистика, ужас...',
      },
      {
        id: '640',
        cat: 'Audio/Audiobook',
        desc: ' |- [Аудио] Зарубежная фантастика, фэнтези, мистика, ужас...',
      },
      {
        id: '697',
        cat: 'Audio/Audiobook',
