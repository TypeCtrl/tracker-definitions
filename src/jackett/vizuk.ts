...
export const definition: TrackerDefinition = {
  ...
  certificates: ['96E34ED4DABD2385DCE9538C80F6F0F02B44AE1A', 'c8614bb9ab6dd074b099bb6d596f7badc557b877'],
  caps: {
    categorymappings: [
  ...
  search: {
    ...
    rows: {
      selector:
        'table#torrents_table_classic > tbody > tr:not(:first-child){{ if .Config.freeleech }}:has(img[src$="torrent_free.png"]){{ else }}{{ end }}, .torrent-box[id^="torrent_"]{{ if .Config.freeleech }}:has(img[src$="torrent_free.png"]){{ else }}{{ end }}',
    },
    fields: {
      category: {
