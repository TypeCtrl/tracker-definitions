...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '47', cat: 'TV/Anime', desc: '   Хентай на Русском языке' },
      {
        id: '48',
        cat: 'TV/Anime',
        desc: '   Хентай Без русского перевода',
      },
      ...
      { id: '52', cat: 'Books/Comics', desc: 'Порно комиксы' },
      {
        id: '49',
        cat: 'XXX/Imageset',
        desc: 'Хентай картинки, иллюстрации, обои и Art ',
      },
  ...
  search: {
    ...
    fields: {
      ...
      details: { selector: 'h2.title a', attribute: 'href' },
      download: { selector: 'h2.title a', attribute: 'href' },
      poster: { selector: 'img.entry-image', attribute: 'src' },
      description: {
