export const definition: any = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://scenehd.org/'],
  certificates: ['81cc4e41b6f8ff656ca0e2396ee6d63383198bf1'],
  caps: {
    categorymappings: [
  ...
  search: {
    ...
    fields: {
      download: { selector: 'td.browse_dl > a', attribute: 'href' },
      title: { selector: 'td.browse_name > a[href^="details.php?id="]' },
      category: {
