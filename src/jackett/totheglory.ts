...
export const definition: TrackerDefinition = {
  ...
  login: {
    ...
    error: [{ selector: 'td.embedded:has(h2:contains("！"))' }, { selector: 'td.embedded:has(h2:contains("!"))' }],
    test: { path: 'my.php' },
  },
  search: {
    paths: [
      { path: 'browse.php', inputs: { c: 'M' } },
      {
        path: 'browse.php',
        categories: [
          1000, 1010, 1020, 1030, 1040, 1050, 1060, 1070, 1080, 1090, 1100, 1110, 1120, 1130, 1140, 1150, 1160, 1170,
          1180, 4000, 4010, 4020, 4030, 4040, 4050, 4060, 4070, 7000, 7010, 7020, 7030, 7040, 7050, 7060,
        ],
        inputs: { c: 'G' },
      },
    ],
