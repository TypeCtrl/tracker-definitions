  ...
  caps: {
    categorymappings: [
      ...
      { id: '147', cat: 'XXX', desc: '  Помощь в поиске порно' },
      {
        id: '148',
        cat: 'XXX',
        desc: '  Правила, помощь, вопросы, предложения по улучшению трекера',
      },
      ...
      { id: '53', cat: 'XXX', desc: '    HD Порно с Русскими актрисами' },
      {
        id: '54',
        cat: 'XXX',
        desc: '    Русское порно. Паки и сборники',
      },
      ...
      { id: '43', cat: 'XXX', desc: '    HD Порнозвезды' },
      {
        id: '44',
        cat: 'XXX',
        desc: '    Порнозвезды. Паки и сборники по актрисам',
      },
      ...
      { id: '13', cat: 'XXX', desc: '  Фетиш' },
      {
        id: '56',
        cat: 'XXX',
        desc: '    Фистинг, фаллоимитаторы, игрушки',
      },
      ...
      { id: '47', cat: 'XXX', desc: '    70-е' },
      {
        id: '12',
        cat: 'XXX',
        desc: '  Вуайеризм и эксгибиционизм, нудизм',
      },
      {
        id: '55',
        cat: 'XXX',
        desc: '    HD Вуайеризм и эксгибиционизм, нудизм',
      },
      ...
      { id: '120', cat: 'XXX', desc: '    Любительские фото' },
      {
        id: '121',
        cat: 'XXX',
        desc: '    Профессиональное, студийное фото',
      },
