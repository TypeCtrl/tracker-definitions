...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '112', cat: 'TV/Sport', desc: 'Instructional - DVD/ISO/WEB' },
      {
        id: '113',
        cat: 'Movies/DVD',
        desc: 'Instructional - DVDRip/Other',
      },
  ...
  settings: [
    ...
    },
    {
      ...
      default: 'seeders',
      options: { name: 'title', size: 'size', seeders: 'seeders' },
    },
    {
      name: 'type',
      type: 'select',
  ...
  search: {
    ...
    fields: {
      ...
      grabs: {
        selector: 'td:nth-child(2)',
        filters: [{ name: 'regexp', args: 'Completed.*(\\d+)' }],
      },
      size: { selector: 'td:nth-child(6)' },
      seeders: { selector: 'td:nth-child(7)' },
      leechers: { selector: 'td:nth-child(8)' },
      downloadvolumefactor: {
        case: { 'img[src="img/freeleech_star.gif"]': 0, '*': 1 },
      },
