...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://takeabyte-nordic.org/'],
  certificates: ['8b88d216d270b9b672ba44fbbdd5ca3d8919e5fd'],
  caps: {
    categorymappings: [
      ...
      { id: '37', cat: 'Console/PSVita', desc: 'Games PS2' },
  ...
  search: {
    ...
    fields: {
      ...
      date: {
        ...
        filters: [
          { name: 'regex', args: ['(.+?)<[^>]*>(.+?)', '$1 $2'] },
          { name: 'dateparse', args: 'Jan 2 2006 15:04:05' },
        ],
      },
