  ...
  caps: {
    categorymappings: [
      ...
      },
      {
        id: '54',
        cat: 'Movies/Other',
        desc: 'Новинки зарубежного кино (CAMRip, TS, Screener)',
      },
      ...
      },
      {
        id: '55',
        cat: 'Movies/Foreign',
        desc: 'Новинки нашего кино (CAMRip, TS, Screener)',
      },
      ...
      { id: '58', cat: 'Movies/Foreign', desc: 'Советское кино' },
      {
        id: '991',
        cat: 'Movies/3D',
        desc: '3D Фильмы, Видео, TV и Спорт',
      },
      ...
      { id: '993', cat: 'Movies/3D', desc: '3D Спорт' },
      {
        id: '994',
        cat: 'Movies/3D',
        desc: '3D Ролики, музыкальное видео, трейлеры к фильмам',
      },
      ...
      { id: '201', cat: 'TV/Anime', desc: 'Аниме' },
      {
        id: '32',
        cat: 'TV/Other',
        desc: 'TV, развлекательные телепередачи и шоу',
      },
      ...
      },
      {
        id: '757',
        cat: 'TV/Other',
        desc: 'Обучающие видео и видеоуроки',
      },
      ...
      { id: '40', cat: 'Audio/Other', desc: 'Другие жанры' },
      {
        id: '241',
        cat: 'Audio/Lossless',
        desc: 'Многоканальная и lossless музыка',
      },
      ...
      { id: '172', cat: 'Other', desc: 'Вопросы и ответы' },
      {
        id: '141',
        cat: 'Other',
        desc: 'Предложения по улучшению трекера',
      },
      ...
      { id: '367', cat: 'Other', desc: 'Трейлеры и доп. материалы' },
      {
        id: '372',
        cat: 'Other',
        desc: 'Фильмографии (режиссеры, актеры)',
      },
      ...
      { id: '814', cat: 'Other', desc: 'Разное' },
      {
        id: '984',
        cat: 'Other',
        desc: 'Видео для телефонов и смартфонов',
      },
      ...
      { id: '668', cat: 'Other', desc: 'Строительство, дизайн и ремонт' },
      {
        id: '669',
        cat: 'Other',
        desc: 'Женские журналы (кулинария, мода, шитьё)',
      },
      ...
      { id: '321', cat: 'Other', desc: 'Паки полных фильмов' },
      {
        id: '399',
        cat: 'Other',
        desc: 'Зарубежные фильмы в высоком качестве (HD)',
      },
      { id: '336', cat: 'Other', desc: 'Зарубежные сайтрипы' },
      {
        id: '338',
        cat: 'Other',
        desc: 'Паки зарубежных pr[o]n роликов по актрисам',
      },
      ...
      { id: '784', cat: 'Other', desc: 'Мультфильмы ( Эротика)' },
      {
        id: '785',
        cat: 'Other',
        desc: 'Документальное и обучающее видео',
      },
      ...
      { id: '799', cat: 'Other', desc: 'Русский ПОП (Караоке Онлайн)' },
      {
        id: '800',
        cat: 'Other',
        desc: 'Русский Шансон (Караоке Онлайн)',
      },
