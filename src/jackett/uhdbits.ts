    ...
    fields: {
      ...
      title: {
        ...
        filters: [
          ...
          { name: 'replace', args: [' / ViE', ''] },
          { name: 'replace', args: [' / User', ''] },
          { name: 'replace', args: [' / Exclusive!', ''] },
          { name: 'replace', args: [' / ↓25%', ''] },
          { name: 'replace', args: [' / ↓50%', ''] },
          { name: 'replace', args: [' / ↓75%', ''] },
          { name: 'replace', args: [' / 2x 50%', ''] },
      ...
      size: { selector: 'td[class="number_column nobr"]' },
      grabs: { selector: 'td[class="number_column nobr"] ~ td' },
      files: { selector: 'td:nth-child(3)' },
      seeders: { selector: 'td[class="number_column nobr"] ~ td ~ td' },
      leechers: {
