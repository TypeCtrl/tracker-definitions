...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://icetorrent.org/'],
  legacylinks: ['https://www.icetorrent.org/'],
  caps: {
    categorymappings: [
  ...
  settings: [
    ...
    },
    {
      ...
      default:
        'The <b>Adult</b> search engine only returns <i>Adult category</i> results.</br>And Vice Versa.',
    },
    {
      name: 'info_Search',
      type: 'info',
      ...
      default:
        'This indexer supports only the <b>English</b> language. Choosing <i>non-English languages</i> will cause incorrect dates to be returned.</br>For best results edit your profile and set your <b>Torrents per page</b> to <b>100</b>. The Default is <i>50</i>.',
    },
  ],
  login: {
    path: 'login',
    ...
    error: [{ selector: 'span:contains("Error")' }, { selector: 'div.alert:contains("failed")' }],
    test: { path: '/', selector: 'a[href*="/logout?_csrf_token="]' },
  },
  ratio: { text: -1 },
  search: {
    paths: [{ path: '{{ if .Config.browseadult }}adult{{else}}browse{{end}}' }],
    inputs: {
    ...
    fields: {
      ...
      date: {
        ...
        attribute: 'title',
        filters: [{ name: 'dateparse', args: 'Jan 2, 2006, 3:04:05 PM' }],
      },
