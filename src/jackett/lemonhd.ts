...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '420', cat: 'Movies/UHD', desc: 'Movies 2160p REMUX' },
      { id: '401', cat: 'Movies/BluRay', desc: 'Movies Blu-ray' },
      { id: '410', cat: 'Movies/HD', desc: 'Movies 1080p' },
      { id: '415', cat: 'Movies', desc: 'Movies 1080p REMUX' },
  ...
  login: {
    ...
    error: [{ selector: 'table:has(a[href="login.php"])' }],
    test: { path: 'index.php' },
  },
  search: {
    ...
    fields: {
      category: {
        ...
        attribute: 'href',
        filters: [{ name: 'regexp', args: 'cat_(\\d{3})' }],
      },
      title: {
        optional: true,
