...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '1060', cat: 'TV/Sport', desc: 'F1 Full Season 2011-2019' },
      {
        id: '1070',
        cat: 'TV/Sport',
        desc: 'F1 Full Season 2011-2019 (HD)',
      },
      ...
      { id: '2050', cat: 'TV/Sport', desc: 'F1 Highlights 2011-2019' },
      {
        id: '2060',
        cat: 'TV/Sport',
        desc: 'F1 Highlights 2011-2019 (HD)',
      },
      ...
      { id: '3050', cat: 'TV/Sport', desc: 'F1 FP and quali 2011-2019' },
      {
        id: '3060',
        cat: 'TV/Sport',
        desc: 'F1 FP and quali 2011-2019 (HD)',
      },
  ...
  search: {
    ...
    fields: {
      ...
      title: { selector: 'span.browseTitle a' },
      download: {
      ...
      files: {
        selector: 'span.torrentData span.torrentFiles',
        filters: [
          { name: 'replace', args: [' in > 100', ' in 100 file'] },
          { name: 'regexp', args: ' in (\\d+) file' },
        ],
      },
      seeders: {
      ...
      leechers: {
        selector: 'span.torrentData span.torrentPeers',
        filters: [{ name: 'regexp', args: 'and (\\d+) leecher' }],
      },
      grabs: {
