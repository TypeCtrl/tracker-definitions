...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '1060', cat: 'TV/Sport', desc: 'F1 Full Season 2011-2020' },
      {
        id: '1070',
        cat: 'TV/Sport',
        desc: 'F1 Full Season 2011-2020 (HD)',
      },
      ...
      { id: '2050', cat: 'TV/Sport', desc: 'F1 Highlights 2011-2020' },
      {
        id: '2060',
        cat: 'TV/Sport',
        desc: 'F1 Highlights 2011-2020 (HD)',
      },
      ...
      { id: '3050', cat: 'TV/Sport', desc: 'F1 FP and quali 2011-2020' },
      {
        id: '3060',
        cat: 'TV/Sport',
        desc: 'F1 FP and quali 2011-2020 (HD)',
      },
      ...
      { id: '5010', cat: 'TV/Sport', desc: 'F1 Misc Documentaries' },
      {
        id: '5020',
        cat: 'TV/Sport',
        desc: 'F1 Misc Driver/team specials',
      },
      ...
      { id: '6000', cat: 'TV/Sport', desc: 'Formula 1 - current season' },
      {
        id: '6010',
        cat: 'TV/Sport',
        desc: 'F1 current season Free practices',
      },
      {
        id: '6020',
        cat: 'TV/Sport',
        desc: 'F1 current season Qualifications',
      },
      { id: '6030', cat: 'TV/Sport', desc: 'F1 current season Races' },
      {
        id: '6040',
        cat: 'TV/Sport',
        desc: 'F1 current season Highlights',
      },
      ...
      { id: '6060', cat: 'TV/Sport', desc: 'F1 current season Other' },
      {
        id: '7000',
        cat: 'TV/Sport',
        desc: 'Formula 1 - current season (HD)',
      },
      {
        id: '7010',
        cat: 'TV/Sport',
        desc: 'F1 current season (HD) Free practices',
      },
      {
        id: '7020',
        cat: 'TV/Sport',
        desc: 'F1 current season (HD) Qualifications',
      },
      {
        id: '7030',
        cat: 'TV/Sport',
        desc: 'F1 current season (HD) Races',
      },
      {
        id: '7040',
        cat: 'TV/Sport',
        desc: 'F1 current season (HD) Highlights',
      },
      {
        id: '7050',
        cat: 'TV/Sport',
        desc: 'F1 current season (HD) Other',
      },
      ...
      { id: '9010', cat: 'TV/Sport', desc: 'Motorbikes AMA' },
      {
        id: '9020',
        cat: 'TV/Sport',
        desc: 'Motorbikes World Supersport',
      },
      {
        id: '9030',
        cat: 'TV/Sport',
        desc: 'Motorbikes World Superstock',
      },
      ...
      { id: '10040', cat: 'TV/Sport', desc: 'Touring cars BTCC' },
      {
        id: '10050',
        cat: 'TV/Sport',
        desc: 'Touring cars Porsche Supercup',
      },
      ...
      { id: '11080', cat: 'TV/Sport', desc: 'Sports cars Super GT' },
      {
        id: '11090',
        cat: 'TV/Sport',
        desc: 'Sports cars IMSA Pilot Challenge',
      },
      ...
      { id: '12000', cat: 'TV/Sport', desc: 'American open-wheelers' },
      {
        id: '12010',
        cat: 'TV/Sport',
        desc: 'American open-wheelers CCWS',
      },
      {
        id: '12020',
        cat: 'TV/Sport',
        desc: 'American open-wheelers IRL',
      },
      {
        id: '12030',
        cat: 'TV/Sport',
        desc: 'American open-wheelers CART',
      },
      {
        id: '12040',
        cat: 'TV/Sport',
        desc: 'American open-wheelers Indycar Series',
      },
      {
        id: '12050',
        cat: 'TV/Sport',
        desc: 'American open-wheelers Indy Lights',
      },
      {
        id: '12060',
        cat: 'TV/Sport',
        desc: 'American open-wheelers Other',
      },
  ...
  login: {
    ...
    error: [{ selector: 'div.front__error' }],
  ...
  search: {
    ...
    rows: { selector: 'div.row:has(div.torrent-item__download)' },
    fields: {
      category: {
        selector: 'div.torrent-item__category span a',
        attribute: 'href',
        filters: [{ name: 'querystring', args: 'c' }],
      },
      title: { selector: 'div.torrent-item__title a' },
      download: {
      ...
      size: { selector: 'div.data-size' },
      seeders: { selector: 'div.data-seeders' },
      leechers: { selector: 'div.data-leechers' },
      grabs: { selector: 'div.data-completed' },
      date: { text: 'now' },
