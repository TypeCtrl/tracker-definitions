...
export const definition: TrackerDefinition = {
  ...
  settings: [
    ...
    { name: 'password', type: 'password', label: 'Password' },
    {
      ...
      label: 'Layout',
      default:
        'Only the classic profile is supported. Make sure to set the "Torrent listesi" option in your profile to "Klasik".',
    },
  ],
  login: {
    path: '?p=home&pid=1',
