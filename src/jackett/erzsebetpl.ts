  ...
  caps: {
    categorymappings: [
      ...
      },
      {
        id: '110',
        cat: 'PC',
        desc: 'Программы для работы с мультимедиа и 3D 3D моделирование, рендеринг и плагины для них',
      },
      ...
      },
      {
        id: '70',
        cat: 'Other',
        desc: 'Компьютерные видеоуроки и обучающие интерактивные DVD Компьютерные сети и безопасность',
      },
      {
        id: '71',
        cat: 'Other',
        desc: 'Компьютерные видеоуроки и обучающие интерактивные DVD ОС и серверные программы Microsoft ',
      },
      {
        id: '72',
        cat: 'Other',
