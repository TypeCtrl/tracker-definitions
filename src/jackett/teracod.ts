...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'ISO-8859-2',
  links: ['https://teracod.net/'],
  legacylinks: ['https://moviezone.ws/'],
  caps: {
    categorymappings: [
  ...
  search: {
    ...
    rows: {
      selector:
        'table > tbody > tr.sh1:has(a[href*="/download.php/"]), table > tbody > tr.sor:has(a[href*="/download.php/"])',
    },
    fields: {
      category: {
      ...
      downloadvolumefactor: {
        case: { 'font[color="#AF0000"]:contains("x0")': 0, '*': 1 },
      },
      uploadvolumefactor: {
        case: { 'font[color="#2A821E"]:contains("x2")': 2, '*': 1 },
      },
      minimumratio: { text: 1 },
