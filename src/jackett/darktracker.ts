...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      { id: '801', cat: 'Movies/3D', desc: ' | Фильмы в формате 3D' },
      {
        id: '802',
        cat: 'Movies/3D',
        desc: ' | Мультфильмы в формате 3D',
      },
      {
        id: '803',
        cat: 'Movies/3D',
        desc: ' | Музыкальные клипы и концерты в формате 3D',
      },
      {
        id: '800',
        cat: 'Movies/3D',
      ...
      { id: '1056', cat: 'Movies/SD', desc: ' | Новинки (CamRip|TS)' },
      {
        id: '1057',
        cat: 'Movies/WEBDL',
        desc: ' | Новинки (HD|DVD|BD|WEB|TV|SAT|PDTV|-Rip)',
      },
      ...
      { id: '60', cat: 'Movies', desc: ' | Фильмы до 2000 года' },
      {
        id: '1114',
        cat: 'Movies/HD',
        desc: ' | Зарубежное кино (HD Video)',
      },
      { id: '65', cat: 'Movies', desc: ' | Антология зарубежного кино' },
      {
        id: '515',
        cat: 'Movies',
        desc: ' | Зарубежные Фильмы для детей',
      },
      ...
      { id: '88', cat: 'Movies', desc: ' | Фильмы до 2000 года' },
      {
        id: '1115',
        cat: 'Movies/HD',
        desc: ' | Отечественное кино (HD Video)',
      },
      {
        id: '516',
        cat: 'Movies',
      ...
      { id: '100', cat: 'TV', desc: ' | Мультфильмы' },
      {
        id: '98',
        cat: 'Audio/Video',
        desc: ' | Музыкальные клипы и концерты',
      },
      ...
      { id: '456', cat: 'Other', desc: 'Мобильное видео' },
      {
        id: '101',
        cat: 'Other',
        desc: 'Дополнительные материалы к фильмам',
      },
      ...
      { id: '721', cat: 'PC/Games', desc: ' | Спортивные симуляторы' },
      {
        id: '720',
        cat: 'PC/Games',
        desc: ' | Космические и Авиа симуляторы',
      },
      ...
      },
      {
        id: '692',
        cat: 'Console/PS3',
        desc: ' | Playstation 3 | Разное',
      },
      { id: '691', cat: 'Console/PS3', desc: ' | PlayStation 2 | Игры' },
      {
        id: '690',
        cat: 'Console/PS3',
        desc: ' | PlayStation 2 | Разное',
      },
      ...
      },
      {
        id: '569',
        cat: 'Audio/MP3',
        desc: ' | Drum & Bass, Jungle, Breakbeat, Dubstep, IDM',
      },
      {
        id: '568',
        cat: 'Audio/MP3',
        desc: ' | House, Techno/MP3, Hardcore, Hardstyle, Jumpstyle',
      },
      {
        id: '567',
        cat: 'Audio/MP3',
        desc: ' | Lo-Fi, Chillout, Lounge, Downtempo/MP3, Trip-Hop, Nu Jazz',
      },
      {
        id: '566',
        cat: 'Audio/MP3',
        desc: ' | Radioshows, Podcasts, Live Sets, Mixes',
      },
      {
        id: '565',
        cat: 'Audio/MP3',
        desc: ' | Traditional Electronic, Ambient, Experimental',
      },
      {
        id: '564',
        cat: 'Audio/MP3',
        desc: ' | Industrial, Noise, EBM, Dark Electro/MP3, New Wave,...',
      },
      ...
      { id: '592', cat: 'Audio/MP3', desc: " | Rap, Hip-Hop, R'n'B" },
      {
        id: '590',
        cat: 'Audio/MP3',
        desc: ' | World Music from other genres',
      },
      ...
      },
      {
        id: '630',
        cat: 'Audio/Lossless',
        desc: ' | House, Techno/Lossless, Hardcore, Hardstyle, Jumpstyle',
      },
      {
        id: '629',
        cat: 'Audio/Lossless',
        desc: ' | Lo-Fi, Chillout, Lounge, Downtempo/Lossless, Trip-Hop, Nu Jazz',
      },
      {
        id: '628',
        cat: 'Audio/Lossless',
      ...
      { id: '634', cat: 'Audio/Lossless', desc: ' | Vocal' },
      {
        id: '637',
        cat: 'Audio/Lossless',
        desc: 'Jazz & Blues & Country (LOSSLESS)',
      },
      ...
      { id: '638', cat: 'Audio/Lossless', desc: ' | Country' },
      {
        id: '642',
        cat: 'Audio/Lossless',
        desc: 'Reggae, Latin, Ethnik (LOSSLESS)',
      },
      ...
      { id: '448', cat: 'Audio', desc: ' | Отечественная' },
      {
        id: '445',
        cat: 'Audio',
        desc: 'Concert Recording & Musical films (Documentary)',
      },
      ...
      },
      {
        id: '744',
        cat: 'TV/Sport',
        desc: ' | Футбольное видео, прочее о футболе',
      },
      ...
      { id: '767', cat: 'TV/Sport', desc: ' | WTA Tour' },
      {
        id: '766',
        cat: 'TV/Sport',
        desc: ' | ATP World Tour Masters 1000',
      },
      ...
      { id: '787', cat: 'TV/Sport', desc: 'Архив' },
      {
        id: '942',
        cat: 'Audio/Audiobook',
        desc: 'Произведения отечественных авторов',
      },
      {
        id: '943',
        cat: 'Audio/Audiobook',
      ...
      },
      {
        id: '944',
        cat: 'Audio/Audiobook',
        desc: ' | Приключения, детектив, боевик, триллер',
      },
      {
        id: '945',
        cat: 'Audio/Audiobook',
      ...
      },
      {
        id: '947',
        cat: 'Audio/Audiobook',
        desc: ' | Современная проза, классика, поэзия',
      },
      {
        id: '946',
        cat: 'Audio/Audiobook',
      ...
      },
      {
        id: '949',
        cat: 'Audio/Audiobook',
        desc: ' | Книги для IPhone, IPod, Apple',
      },
      {
        id: '951',
        cat: 'Audio/Audiobook',
      ...
      { id: '952', cat: 'Audio/Audiobook', desc: ' | Сатира, Юмор' },
      {
        id: '955',
        cat: 'Audio/Audiobook',
        desc: 'Произведения зарубежных авторов',
      },
      {
        id: '967',
        cat: 'Audio/Audiobook',
      ...
      },
      {
        id: '1019',
        cat: 'Audio/Audiobook',
        desc: ' | Разножанровые, многоавторские сборники',
      },
      {
        id: '970',
        cat: 'Audio/Audiobook',
        desc: ' | Обучающая и научно-популярная литература',
      },
      {
        id: '971',
        cat: 'Audio/Audiobook',
      ...
      },
      {
        id: '972',
        cat: 'Audio/Audiobook',
        desc: ' | Психология, Тренинг, Саморазвитие',
      },
      {
        id: '973',
        cat: 'Audio/Audiobook',
        desc: ' | Философия и религия',
      },
      ...
      { id: '992', cat: 'Books', desc: 'Прочая литература' },
      {
        id: '1028',
        cat: 'Books',
        desc: ' | ЖЗЛ. Биографии. Мемуары. Историография.',
      },
      {
        id: '1004',
        cat: 'Books',
        desc: ' | Философия, Религия, Эзотерика',
      },
      {
        id: '1050',
        cat: 'Books',
        desc: ' | Публицистика, Социология и Политология',
      },
      {
        id: '1005',
        cat: 'Books',
        desc: ' | Художественная литература на ин языках',
      },
      {
        id: '1018',
        cat: 'Books',
      ...
      },
      {
        id: '1002',
        cat: 'Books',
        desc: ' | Техническая и научно-популярная литература',
      },
      {
        id: '1001',
        cat: 'Books',
      ...
      },
      {
        id: '1067',
        cat: 'Books',
        desc: ' | Домоводство, Сад, Огород, Хобби',
      },
      ...
      { id: '999', cat: 'Books', desc: ' | Медицина и Здоровье' },
      {
        id: '998',
        cat: 'Books',
        desc: ' | Бизнес, Право, Экономика, Финансы',
      },
      {
        id: '997',
        cat: 'Books',
        desc: ' | Разножанровые коллекции книг и библиотеки',
      },
      { id: '996', cat: 'Books', desc: ' | Компьютерная литература' },
      {
        id: '1094',
        cat: 'Books',
        desc: ' | Компьютерная литература на иностранных языках',
      },
      {
        id: '995',
        cat: 'Books',
        desc: ' | Справочники, энциклопедии и словари',
      },
      {
        id: '1090',
        cat: 'Books',
        desc: ' | Обучающая и развивающая литература, учебники',
      },
      ...
      { id: '1068', cat: 'Books', desc: ' | Кулинария' },
      {
        id: '1013',
        cat: 'Books',
        desc: ' | Игровые и Компьютерные журналы',
      },
      { id: '1012', cat: 'Books', desc: ' | Мультимедийные приложения' },
      {
        id: '1011',
        cat: 'Books',
        desc: ' | Научно-популярные, техника, авто',
      },
      {
        id: '1101',
        cat: 'Books',
      ...
      },
      {
        id: '464',
        cat: 'Books',
        desc: ' | Комиксы, Графика, Wallpapers, Арт',
      },
      ...
      },
      {
        id: '1093',
        cat: 'Books',
        desc: ' | Журналы и газеты на иностранных языках',
      },
      {
        id: '295',
        cat: 'Books',
        desc: 'Книги и журналы для самых маленьких и их родителей',
      },
      { id: '468', cat: 'Books', desc: 'Архив' },
      {
        id: '834',
        cat: 'PC/0day',
        desc: 'Операционные системы от Microsoft',
      },
      {
        id: '844',
        cat: 'PC/0day',
      ...
      },
      {
        id: '1084',
        cat: 'PC/0day',
        desc: ' | Windows 8 / 8.1 (оригинальные образы)',
      },
      {
        id: '1085',
        cat: 'PC/0day',
        desc: ' | Windows 7 (оригинальные образы)',
      },
      {
        id: '1086',
        cat: 'PC/0day',
        desc: ' | Windows Vista (оригинальные образы)',
      },
      {
        id: '1087',
        cat: 'PC/0day',
        desc: ' | Windows XP (оригинальные образы)',
      },
      {
        id: '1088',
        cat: 'PC/0day',
        desc: ' | Windows OS, выпущенные до 2001 года (оригинальные образы)',
      },
      ...
      { id: '840', cat: 'PC/0day', desc: ' | Сборки Windows XP' },
      {
        id: '1051',
        cat: 'PC/0day',
        desc: ' | Сборки Windows - &quot;все в одном&quot;',
      },
      { id: '839', cat: 'PC/0day', desc: ' | Серверные ОС' },
      {
        id: '838',
        cat: 'PC/0day',
        desc: ' | Патчи, RC, Beta, Service Packs и дополнения для ОС от...',
      },
      ...
      { id: '836', cat: 'PC/0day', desc: ' | Разное (Windows)' },
      {
        id: '1029',
        cat: 'PC/0day',
        desc: ' | Активация ОС Windows и ПО Microsoft',
      },
      { id: '1071', cat: 'PC/0day', desc: ' | Архив' },
      {
        id: '845',
        cat: 'PC/Mac',
        desc: 'Операционные системы и ПО для Apple Macintosh',
      },
      ...
      },
      {
        id: '849',
        cat: 'PC/Mac',
        desc: ' | Программы для просмотра и обработки видео',
      },
      {
        id: '848',
        cat: 'PC/Mac',
        desc: ' | Mac OS Программы для просмотра и обработки графики',
      },
      {
        id: '847',
        cat: 'PC/Mac',
        desc: ' | Mac OS Аудио редакторы и конверторы для Mac OS',
      },
      {
        id: '846',
        cat: 'PC/Mac',
      ...
      { id: '1072', cat: 'PC/Mac', desc: ' | Архив' },
      {
        id: '853',
        cat: 'PC',
        desc: 'Операционные системы и ПО для Linux, Unix и других ОС',
      },
      ...
      { id: '918', cat: 'PC', desc: ' | Live /PE/ Boot CD (DVD, USB)' },
      {
        id: '875',
        cat: 'PC',
        desc: ' | Настройка и оптимизация ОС (software)',
      },
      {
        id: '874',
        cat: 'PC',
        desc: ' | Резервное копирование и восстановление данных',
      },
      {
        id: '1092',
        cat: 'PC',
      ...
      { id: '872', cat: 'PC', desc: ' | Сборники программ' },
      {
        id: '871',
        cat: 'PC',
        desc: ' | Работа с носителями информации (SSD, HDD, USB, DVD, CD)',
      },
      {
        id: '1098',
        cat: 'PC',
        desc: ' | Программы для работы с ПК со смартфонами (планшетами) н...',
      },
      ...
      { id: '884', cat: 'PC', desc: ' | Офисные системы' },
      {
        id: '1102',
        cat: 'PC',
        desc: ' | Дополнения (надстройки и т.д.) для офисных систем',
      },
      ...
      },
      {
        id: '889',
        cat: 'PC',
        desc: ' | Программы для верстки, сканирования, печати и работы ...',
      },
      ...
      { id: '917', cat: 'PC', desc: ' | Консультант Плюс' },
      {
        id: '1070',
        cat: 'PC',
        desc: ' | КонсультантБухгалтер: Версия Проф',
      },
      { id: '1036', cat: 'PC', desc: ' | Архив Консультант Плюс' },
      {
        id: '916',
        cat: 'PC',
        desc: ' | Другие справочно-правовые системы',
      },
      { id: '914', cat: 'PC', desc: ' | Справочные системы' },
      {
        id: '915',
        cat: 'PC',
        desc: ' | Общий архив раздела &quot;Справочно-правовые системы&quot;',
      },
      ...
      { id: '1105', cat: 'PC', desc: ' | Garmin' },
      {
        id: '1104',
        cat: 'PC/0day',
        desc: ' | Windows XP/Vista/7/8/8.1/10',
      },
      { id: '1103', cat: 'PC/0day', desc: ' | Windows CE' },
      {
        id: '1108',
        cat: 'PC',
        desc: ' | Разное (Системы навигации и карты, ГИС)',
      },
      {
        id: '1097',
        cat: 'PC',
        desc: ' | Архив (Системы навигации и карты, ГИС)',
      },
      {
        id: '885',
        cat: 'PC',
      ...
      { id: '893', cat: 'PC', desc: ' | Редакторы и конвертеры графики' },
      {
        id: '891',
        cat: 'PC',
        desc: ' | Работа со звуком, Редакторы видео',
      },
      {
        id: '888',
        cat: 'PC',
        desc: ' | Аудио и видео  плееры, рекордеры и кодеки',
      },
      {
        id: '887',
        cat: 'PC',
        desc: ' | Каталогизаторы и просмотр графики',
      },
      ...
      { id: '906', cat: 'PC', desc: ' | 3D модели и сцены Photostoсks' },
      {
        id: '905',
        cat: 'PC',
        desc: ' | Заготовки, виньетки, костюмы, шаблоны и рамки',
      },
      ...
      { id: '902', cat: 'PC', desc: ' | Шрифты' },
      {
        id: '901',
        cat: 'PC',
        desc: ' | Библиотеки сэмплов и Звуковые эффекты',
      },
      ...
      },
      {
        id: '1110',
        cat: 'TV/Sport',
        desc: 'Программы для прошивки и диагностики авто, прошивки',
      },
      ...
      { id: '1112', cat: 'TV/Sport', desc: 'Водный транспорт' },
      {
        id: '1113',
        cat: 'TV/Sport',
        desc: 'Видео по ремонту и тюнингу ТС',
      },
      ...
      { id: '1043', cat: 'XXX', desc: ' | Фильмы до 2000 года' },
      {
        id: '1042',
        cat: 'XXX',
        desc: ' | Зарубежные фильмы с переводом',
      },
  ...
  search: {
    ...
    fields: {
      ...
      description: {
        selector: 'a[href^="viewforum.php?f="]',
        filters: [{ name: 'prepend', args: 'cat={{ .Result.descr_cat }} ' }],
      },
      title: {
