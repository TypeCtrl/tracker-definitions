  ...
  caps: {
    categorymappings: [
      ...
      },
      {
        id: '100',
        cat: 'Movies',
        desc: 'Видео для портативных устройств',
      },
      {
        id: '105',
        cat: 'Movies',
      ...
      },
      {
        id: '836',
        cat: 'Movies/HD',
        desc: 'Классика зарубежного кино HD',
      },
      ...
      },
      {
        id: '194',
        cat: 'TV',
        desc: 'Анатомия страcти / Grey&#039;s Anatomy',
      },
      ...
      { id: '997', cat: 'TV', desc: 'Банши / Banshee' },
      {
        id: '153',
        cat: 'TV',
        desc: 'Баффи - Истребительница вампиров / Buffy the Vampire...',
      },
      ...
      { id: '90', cat: 'TV', desc: 'Герои / Heroes' },
      {
        id: '86',
        cat: 'TV',
        desc: 'Говорящая с призраками / Ghost Whisperer',
      },
      ...
      { id: '81', cat: 'TV', desc: 'Декстер / Dexter' },
      {
        id: '114',
        cat: 'TV',
        desc: 'Демоны Да Винчи / Da Vinci&#039;s Demons',
      },
      ...
      { id: '220', cat: 'TV', desc: 'Игра Престолов / Game of Thrones' },
      {
        id: '245',
        cat: 'TV',
        desc: 'Как сказал Джим / According to Jim',
      },
      {
        id: '201',
        cat: 'TV',
      ...
      { id: '62', cat: 'TV', desc: 'Клиника / Scrubs' },
      {
        id: '424',
        cat: 'TV',
        desc: 'Легенда об Искателе / Legend of the Seeker',
      },
      ...
      { id: '63', cat: 'TV', desc: 'Побег / Prison Break' },
      {
        id: '1005',
        cat: 'TV',
        desc: 'Полтергейст: Наследие / Poltergeist: The Legacy',
      },
      ...
      { id: '1006', cat: 'TV', desc: 'Прослушка / The Wire' },
      {
        id: '167',
        cat: 'TV',
        desc: 'Пуаро Агаты Кристи / Agatha Christie&#039;s Poirot',
      },
      ...
      { id: '11', cat: 'TV', desc: 'Мультсериалы' },
      {
        id: '383',
        cat: 'TV',
        desc: 'Аватар: Легенда об Аанге / Avatar: The Last Airbender',
      },
      {
        id: '889',
        cat: 'TV',
        desc: 'Американский папаша / American Dad! (Seth MacFarlane)',
      },
      ...
      { id: '168', cat: 'TV', desc: 'Букашки / Minuscule' },
      {
        id: '758',
        cat: 'TV',
        desc: 'Гриффины / Family Guy (Seth MacFarlane)',
      },
      {
        id: '934',
        cat: 'TV',
        desc: 'Губка Боб Квадратные Штаны / SpongeBob SquarePants',
      },
      ...
      { id: '935', cat: 'TV', desc: 'Маша и Медведь' },
      {
        id: '133',
        cat: 'TV',
        desc: 'Мыши-байкеры с Марса / Biker Mice from Mars',
      },
      { id: '652', cat: 'TV', desc: 'Охотники за привидениями' },
      {
        id: '936',
        cat: 'TV',
        desc: 'Пингвины из Мадагаскара / The Penguins of Madagascar',
      },
      ...
      { id: '382', cat: 'TV', desc: 'Школа волшебниц / Winx Club' },
      {
        id: '939',
        cat: 'TV',
        desc: 'Шоу Кливленда / The Cleveland Show (Seth MacFarlane)',
      },
      ...
      { id: '635', cat: 'TV', desc: 'Диагностика кармы' },
      {
        id: '929',
        cat: 'TV',
        desc: 'Документальные фильмы на языке оригинала',
      },
      ...
      { id: '551', cat: 'TV', desc: 'Top Gear' },
      {
        id: '877',
        cat: 'TV',
        desc: 'Авторские шоу и концерты, бенефисы и концертографии',
      },
      ...
      { id: '858', cat: 'TV', desc: 'Пародийные телепередачи и шоу' },
      {
        id: '632',
        cat: 'TV',
        desc: 'Познавательно-развлекательные телепередачи, игры и виктори...',
      },
      { id: '621', cat: 'TV', desc: 'Пост-КВН и Молодежные скетч-шоу' },
      {
        id: '857',
        cat: 'TV',
        desc: 'Премии вручения, праздничные и новогодние программы',
      },
      {
        id: '930',
        cat: 'TV',
        desc: 'Развлекательные телепередачи на языке оригинала',
      },
      ...
      { id: '208', cat: 'TV', desc: 'Автоспорт' },
      {
        id: '750',
        cat: 'TV',
        desc: 'Американский футбол, регби и бейсбол',
      },
      ...
      { id: '673', cat: 'TV', desc: 'Теннис' },
      {
        id: '791',
        cat: 'TV',
        desc: 'Зимние Олимпийские Игры 2014 в Сочи',
      },
      ...
      { id: '794', cat: 'TV', desc: 'Лыжный спорт' },
      {
        id: '971',
        cat: 'TV',
        desc: 'Сноуборд/Фристайл/Шорт-трек/Керлинг',
      },
      ...
      { id: '792', cat: 'TV', desc: 'Хоккей' },
      {
        id: '797',
        cat: 'TV',
        desc: 'Обзорные и разные тематические передачи',
      },
      ...
      { id: '491', cat: 'TV', desc: 'Международные лиги и кубки' },
      {
        id: '492',
        cat: 'TV',
        desc: 'Национальные чемпионаты и кубки зарубежных стран',
      },
      ...
      { id: '438', cat: 'Audio', desc: 'Techno / Minimal / Tech House' },
      {
        id: '535',
        cat: 'Audio',
        desc: 'Techno / Minimal / Tech House (lossless)',
      },
      ...
      { id: '419', cat: 'Audio', desc: 'Hardcore / Hardstyle' },
      {
        id: '545',
        cat: 'Audio',
        desc: 'Hardcore / Hardstyle (lossless)',
      },
