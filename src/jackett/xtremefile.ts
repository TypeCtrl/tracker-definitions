...
export const definition: TrackerDefinition = {
  ...
  search: {
    ...
    rows: { selector: 'table tbody tr.browse, table tbody tr.sticky' },
    fields: {
      category: {
      ...
      title: { selector: 'a[href^="details.php?id="][onmouseover]' },
      details: {
      ...
      uploadvolumefactor: { case: { 'img[src="pic/x2.png"]': 2, '*': 1 } },
    },
  },
  source: 'jackett',
};
