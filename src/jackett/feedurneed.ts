...
export const definition: TrackerDefinition = {
  ...
  login: {
    ...
    error: [{ selector: 'div.padding20:has(h2:contains("Error"))' }],
  ...
  search: {
    ...
    fields: {
      ...
      banner: { selector: 'img[alt="Poster"]', attribute: 'data-src' },
      ...
      grabs: { selector: 'a[href*="/snatches.php?id="]' },
      downloadvolumefactor: {
        case: { 'img[data-src="./images/gold.png"]': 0, '*': 1 },
      },
      uploadvolumefactor: {
        case: { 'img[data-src="./images/doubleseed.gif"]': 2, '*': 1 },
      },
      category: {
      ...
      date: {
        ...
        filters: [
          ...
          { name: 'dateparse', args: 'Jan 2 2006 3:04:05 pm' },
        ],
      },
    },
  },
