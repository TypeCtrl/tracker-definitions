...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      { id: '5', cat: 'PC', desc: 'Special OS' },
      {
        id: '6',
        cat: 'PC',
        desc: 'Special Release [Requested/Exclusive/Etc]',
      },
      ...
      { id: '49', cat: 'PC', desc: 'Windows 7 64 Bit Untouched (MSDN)' },
      {
        id: '50',
        cat: 'PC/ISO',
        desc: 'Windows 7 x86/64+AIO Untouched ISO',
      },
      { id: '51', cat: 'PC', desc: 'Windows 8&8.1 Untouched (MSDN)' },
      {
        id: '52',
        cat: 'PC',
        desc: 'Windows 8&8.1 32 Bit Untouched (MSDN)',
      },
      {
        id: '53',
        cat: 'PC',
        desc: 'Windows 8&8.1 64 Bit Untouched (MSDN)',
      },
      {
        id: '54',
        cat: 'PC/ISO',
        desc: 'Windows 8&8.1 x86/64+AIO Untouched ISO',
      },
      { id: '55', cat: 'PC', desc: 'Windows Server 2003 (Untouched)' },
      {
        id: '56',
        cat: 'PC',
        desc: 'Windows Server 2003 32 Bit Untouched',
      },
      {
        id: '57',
        cat: 'PC',
        desc: 'Windows Server 2003 64 Bit Untouched',
      },
      {
        id: '58',
        cat: 'PC/ISO',
      ...
      { id: '70', cat: 'PC/0day', desc: 'Utility Tools' },
      {
        id: '71',
        cat: 'PC/0day',
        desc: 'Activators/ Crack/ patch/ keygen',
      },
      ...
      { id: '86', cat: 'Books/Ebook', desc: 'Ebooks' },
      {
        id: '87',
        cat: 'Other',
        desc: 'Wallpapers, Themes & Screensavers',
      },
      ...
      { id: '132', cat: 'PC/Mobile-Other', desc: 'Linux/Unix' },
  ...
  login: {
    ...
    test: { path: '/', selector: 'a[href="/account/"]' },
  },
  search: {
    paths: [
      {
    ...
    fields: {
      ...
      title: { selector: 'a[href^="/threads/"]' },
      details: { selector: 'a[href^="/threads/"]', attribute: 'href' },
