...
export const definition: TrackerDefinition = {
  id: 'freetorrent',
  name: 'FreeTorrent',
  description: 'FreeTorrent is a Semi-Private Torrent Tracker for HD MOVIES / TV',
  language: 'en-US',
  type: 'semi-private',
  encoding: 'UTF-8',
  links: ['https://freetorrent.tk/'],
  legacylinks: ['https://FreeTorrent.net/', 'https://FreeTorrent.xyz/'],
  caps: {
    categorymappings: [
