...
export const definition: TrackerDefinition = {
  ...
  login: {
    ...
    error: [{ selector: 'h2:contains("Error")', message: { selector: 'p' } }],
  ...
  search: {
    ...
    fields: {
      ...
      date: {
        ...
        filters: [{ name: 'dateparse', args: '2 Jan 2006 15:04:05' }],
      },
      ...
      downloadvolumefactor: {
        case: { 'img[src="./images/gold.png"]': '0', '*': '1' },
      },
