...
export const definition: TopLevel = {
  ...
  search: {
    ...
    fields: {
      'title-attribute': { selector: 'a.tname', attribute: 'title' },
      'title-text': { selector: 'a.tname' },
      title: {
        text:
          '{{if .Result.title-attribute }}{{ .Result.title-attribute }}{{else}}{{ .Result.title-text }}{{end}}',
      },
