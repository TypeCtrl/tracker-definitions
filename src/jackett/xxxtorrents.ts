...
export const definition: TrackerDefinition = {
  ...
  type: 'public',
  encoding: 'UTF-8',
  links: ['https://www.xxxtorrents.pro/'],
  caps: {
    categorymappings: [
      { id: '170', cat: 'XXX', desc: 'Temp' },
      {
        id: '19',
        cat: 'XXX',
      ...
      },
      {
        id: '117',
        cat: 'XXX',
        desc: ' |- Фильмы с сюжетом / Movies with a plot',
      },
      {
        id: '162',
        cat: 'XXX',
      ...
      },
      {
        id: '171',
        cat: 'XXX',
        desc: ' |- Фильмы без сюжета 2020 года / Films without a plot in 2020',
      },
      {
        id: '114',
        cat: 'XXX',
        desc: ' |- Фильмы без сюжета 2011-2019 / Movies without plot of...',
      },
      {
        id: '150',
        cat: 'XXX',
        desc: ' |- Фильмы без сюжета до 2010 / Movies without plot till 2010',
      },
      {
        id: '146',
        cat: 'XXX',
        desc: ' |- Фильмы и видео компиляции (с переводом RUS)',
      },
      { id: '131', cat: 'XXX', desc: ' |- Порно пародии / Parody porn' },
      { id: '116', cat: 'XXX', desc: ' |- Гонзо-фильмы / Gonzo' },
      {
        id: '112',
        cat: 'XXX',
      ...
      },
      {
        id: '22',
        cat: 'XXX',
        desc: 'Зарубежные фильмы в высоком качестве (HD Video)',
      },
      { id: '107', cat: 'XXX', desc: ' |- Фильмы с сюжетом (HD Video)' },
      {
        id: '163',
        cat: 'XXX',
        desc: ' |- Фильмы студии Marc Dorcel (франция) HD video',
      },
      {
        id: '106',
        cat: 'XXX',
        desc: ' |- Гонзо и Фильмы без сюжета (HD Video)',
      },
      {
        id: '142',
        cat: 'XXX',
      ...
      { id: '167', cat: 'XXX', desc: ' |- Сайтрипы 2019 (480p, 540p' },
      {
        id: '89',
        cat: 'XXX',
        desc: ' |- Сайтрипы 2010-2018 (480p, 540p',
      },
      {
        id: '137',
        cat: 'XXX',
      ...
      },
      {
        id: '84',
        cat: 'XXX',
        desc: ' |- Любительское видео / Amateur Video (WebCam, CamRip',
      },
      { id: '23', cat: 'XXX', desc: 'Русское порно / Russian Video' },
      {
        id: '105',
        cat: 'XXX',
      ...
      },
      {
        id: '103',
        cat: 'XXX',
        desc: ' |- Сайтрипы с русскими актрисами (HD Video',
      },
      {
        id: '102',
        cat: 'XXX',
        desc: ' |- Сайтрипы с русскими актрисами (480p, 540p',
      },
      {
        id: '104',
        cat: 'XXX',
      ...
      },
      {
        id: '26',
        cat: 'XXX',
        desc: 'Японское порно без цензуры / Japan uncensored porno',
      },
      {
        id: '82',
        cat: 'XXX',
        desc: ' |- Японские фильмы и сайтрипы (HD Video 720p, 1080p',
      },
      {
        id: '81',
        cat: 'XXX',
        desc: ' |- Японские фильмы и сайтрипы (Definition 480p-540p',
      },
      {
        id: '83',
        cat: 'XXX',
        desc: ' |- Паки японских фильмов и сайтрипов / Japanese Packs',
      },
      {
        id: '30',
        cat: 'XXX',
      ...
      },
      {
        id: '48',
        cat: 'XXX',
        desc: ' |- Буккаке, Камшот / Bukkake, Glory Hole, Cumshot Compilation',
      },
      {
        id: '52',
        cat: 'XXX',
      ...
      },
      {
        id: '152',
        cat: 'XXX',
        desc: ' |- Порно с животными / Porn with animals',
      },
      {
        id: '133',
        cat: 'XXX',
      ...
      { id: '49', cat: 'XXX', desc: ' |- Беременные / Pregnant' },
      { id: '55', cat: 'XXX', desc: ' |- Бисексуалы / Bisexual' },
      {
        id: '28',
        cat: 'XXX',
      ...
      },
      {
        id: '74',
        cat: 'XXX',
        desc: " |- Подборки фото сайтрипов / SiteRip's Picture Packs",
      },
      {
        id: '73',
        cat: 'XXX',
      ...
      { id: '33', cat: 'XXX', desc: ' |- ✂ Недооформленное ✂' },
    ],
