...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '9', cat: 'Movies/HD', desc: 'DVDRip/BRRip/BDRip' },
      {
        id: '10',
        cat: 'Movies/SD',
        desc: 'Screeners/R3/R5/R6/HDRip/Webrip/WEB-DL/Recodes',
      },
      ...
      { id: '15', cat: 'Movies/UHD', desc: 'High Definition MKV/MP4' },
      {
        id: '16',
        cat: 'Movies/SD',
        desc: 'Cams TS & TC/PPV/VOD/HDTV *Ratio Free*',
      },
      {
        id: '17',
        cat: 'Movies/UHD',
        desc: '4k Ultra High Definition  *Ratio Free*',
      },
      ...
      { id: '22', cat: 'Audio', desc: 'Rock/Heavy Metal/Alternative' },
      {
        id: '23',
        cat: 'Audio',
        desc: 'Amateur Creations/Live DJ Sets etc/Karaoke',
      },
      ...
      { id: '25', cat: 'Audio', desc: 'Pop albums' },
      {
        id: '26',
        cat: 'Audio',
        desc: 'Drum & Bass/Breakbeat/Garage/Hardcore',
      },
      ...
      { id: '42', cat: 'Console/PS3', desc: 'Playstation' },
      {
        id: '43',
        cat: 'Console/Other',
        desc: 'All Other Console Roms & Emulators',
      },
      { id: '47', cat: 'PC/Mac', desc: 'Mac & Other OS Games' },
      {
        id: '49',
        cat: 'PC/Games',
        desc: 'DVDR Interactive Games & Quizzes',
      },
      ...
      { id: '53', cat: 'PC', desc: 'Applications' },
      {
        id: '55',
        cat: 'PC',
        desc: 'Windows Operating Systems & MS Apps',
      },
      ...
      { id: '91', cat: 'Movies/3D', desc: 'Movies 3D' },
      {
        id: '132',
        cat: 'Other',
        desc: 'Practice your uploading skills in here',
      },
  ...
  search: {
    ...
    rows: { selector: 'table.dataList-table > tbody.normal-torrents > tr' },
    fields: {
      category: {
      ...
      title: { selector: 'div.structItem-title a' },
      details: {
      ...
      magnet: { selector: 'a[href^="magnet:?x"]', attribute: 'href' },
      ...
      downloadvolumefactor: { case: { 'span.label--accent': 0, '*': 1 } },
