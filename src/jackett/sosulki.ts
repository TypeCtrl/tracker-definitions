...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '65', cat: 'XXX', desc: 'Порноролики зарубежные ' },
      {
        id: '66',
        cat: 'XXX',
        desc: 'Русское Порно Любительское (Amateur Russian)',
      },
  ...
  search: {
    ...
    rows: { selector: 'tr.fr_viewn_in:not(td.frs:empty)' },
    fields: {
      category: {
      ...
      title: { selector: 'td.titlelast a', attribute: 'title' },
      details: { selector: 'td.titlelast a', attribute: 'href' },
