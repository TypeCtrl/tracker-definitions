...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '40', cat: 'Console/Xbox360', desc: 'Games / XBOX-360' },
  ...
  login: {
    ...
    error: [{ selector: 'div.row div#container div.alert' }],
  ...
  search: {
    ...
    rows: { selector: 'tr:has(a[href^="/en/torrents/?category="])' },
    fields: {
      category: {
      ...
      date: {
        selector: 'div.row',
        filters: [
          { name: 'regexp', args: 'uplodaded (.+?),' },
          { name: 'append', args: ' +02:00' },
          { name: 'dateparse', args: '2 January 2006 -07:00' },
        ],
      },
