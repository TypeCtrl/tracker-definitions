...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: 'x264', cat: 'Movies/HD', desc: 'Movies / x264' },
      {
        id: 'animemanga',
        cat: 'TV/Anime',
        desc: 'Movies / Anime & Manga',
      },
      {
        id: 'documentaries',
        cat: 'TV/Documentary',
        desc: 'Movies / Documentaries',
      },
    ...
    error: [
      {
        ...
        message: { selector: 'div.row div div.alert' },
      },
    ],
  ...
  search: {
    ...
    rows: { selector: 'tr:has(td.category)' },
    fields: {
      title: { selector: 'td.filename div:nth-child(2) a' },
      details: { selector: 'td.filename div a', attribute: 'href' },
      category: {
