...
export const definition: TopLevel = {
  ...
  settings: [
    ...
    },
    {
      ...
      default:
        'For results in the following categories you must edit your profile.<br />- Straight<br />- Bisexual<br />- Scat',
    },
  ],
  caps: {
    categorymappings: [
  ...
  search: {
    ...
    fields: {
      ...
      leechers: { optional: true, selector: 'a[href$="&todlers=1"]' },
      date: {
        selector: '.tadded',
        filters: [
          {
