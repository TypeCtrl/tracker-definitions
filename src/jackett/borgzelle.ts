...
export const definition: TrackerDefinition = {
  ...
  type: 'private',
  encoding: 'UTF-8',
  links: ['https://borgzelle.borg/'],
  certificates: ['a3f8822c97fbfe5bd00760cf8e6b75c4284f657d'],
  caps: {
    categorymappings: [
  ...
  search: {
    ...
    rows: {
      selector:
        'table[style="width: 100%;"] > tbody > tr{{ if .Config.freeleech }}:has(span:contains("[OnlyUpload]")){{ else }}{{ end }}',
    },
    fields: {
      category: {
      ...
      title: { selector: 'a[href^="torrents.php?torrentid="]' },
      details: {
      ...
      downloadvolumefactor: {
        case: { 'span:contains("[OnlyUpload]")': 0, '*': 1 },
      },
