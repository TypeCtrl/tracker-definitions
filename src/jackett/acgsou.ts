  ...
  caps: {
    categorymappings: [
      ...
      { id: '8', cat: 'TV/Anime', desc: '动画合集 (Anime Collection)' },
      {
        id: '14',
        cat: 'TV/Anime',
        desc: '英译动画 (Anime English Translation)',
      },
      ...
      { id: '3', cat: 'Books/Comics', desc: '漫画 (Manga)' },
      {
        id: '12',
        cat: 'Books/Comics',
        desc: '港台漫画 (Manga Hong Kong and Taiwan)',
      },
      {
        id: '13',
        cat: 'Books/Comics',
        desc: '原版日漫 (Manga Original Japanese)',
      },
      {
        id: '16',
        cat: 'Books/Comics',
        desc: '英译漫画 (Manga English Translation)',
      },
      ...
      { id: '22', cat: 'TV', desc: '原版日剧 (Drama Original Japanese)' },
      {
        id: '23',
        cat: 'TV',
        desc: '英译日剧 (Drama English Translation)',
      },
