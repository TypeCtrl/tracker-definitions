    ...
    fields: {
      title: {
        ...
        filters: [
          ...
          { name: 'replace', args: [' (Золото)', ''] },
          { name: 'replace', args: ['-Rip', 'Rip'] },
          { name: 'replace', args: ['WEB-DL', 'WEBDL'] },
          { name: 'replace', args: ['WEBRip', 'WEBDL'] },
          { name: 're_replace', args: ['WEBDLRip', 'WEBDL'] },
          { name: 'replace', args: ['HD720p', 'HD 720p'] },
          { name: 'replace', args: ['HDR720p', 'HD 720p'] },
          { name: 'replace', args: ['HD1080p', 'HD 1080p'] },
          { name: 'replace', args: ['HDR1080p', 'HD 1080p'] },
          {
            name: 're_replace',
            args: [
