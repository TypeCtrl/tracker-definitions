...
export const definition: TrackerDefinition = {
  ...
  search: {
    ...
    fields: {
      ...
      files: {
        selector:
          'td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(1) > b:nth-child(2), a[href*="&filelist=1"]',
      },
      grabs: {
        selector:
          'td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(3) > b:nth-child(1), a[href*="&tosnatchers=1"]',
      },
      size: {
        selector:
      ...
      seeders: {
        selector:
          'td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(2) > b:nth-child(1), a[href*="&toseeders=1"]',
      },
      leechers: {
        selector:
