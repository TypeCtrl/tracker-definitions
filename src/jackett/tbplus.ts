...
export const definition: TrackerDefinition = {
  ...
  caps: {
    categorymappings: [
      ...
      { id: '15', cat: 'Movies/HD', desc: 'DVD-BRscreener - Estrenos' },
      {
        id: '16',
        cat: 'Movies/HD',
        desc: 'DVDScrn/BRScrn MKV - Estrenos',
      },
      {
        id: '18',
        cat: 'Movies/SD',
        desc: 'Xvid/DVDRip MKV - Películas / Documentales',
      },
      {
        id: '19',
        cat: 'Movies/HD',
        desc: 'HD - Películas / Documentales',
      },
      {
        id: '20',
        cat: 'Movies/HD',
        desc: 'Dvd / Full Bluray - Películas / Documentales',
      },
      {
        id: '74',
        cat: 'Movies/HD',
        desc: '3D - Películas / Documentales',
      },
      {
        id: '69',
        cat: 'Movies/SD',
        desc: 'MP4 - Películas / Documentales',
      },
      {
        id: '75',
        cat: 'Movies/HD',
        desc: 'MicroHD - Películas / Documentales',
      },
      ...
      { id: '77', cat: 'TV/Sport', desc: 'MicroHD - Deportes' },
      {
        id: '30',
        cat: 'TV/Anime',
        desc: 'Xvid/DVDRip MKV - Anime / Animación',
      },
      { id: '31', cat: 'TV/Anime', desc: 'HD - Anime / Animación' },
      {
        id: '32',
        cat: 'TV/Anime',
        desc: 'DVD / Full Bluray - Anime / Animación',
      },
      ...
      { id: '52', cat: 'PC', desc: 'OS - Mac - Apps / Software' },
      {
        id: '53',
        cat: 'PC',
        desc: 'Herramientas Windows - Apps / Software',
      },
      {
        id: '54',
        cat: 'PC',
        desc: 'Herramientas Linux - Apps / Software',
      },
      {
        id: '55',
        cat: 'PC/Mac',
        desc: 'Herramientas Mac - Apps / Software',
      },
      {
        id: '56',
        cat: 'PC/ISO',
        desc: 'Imagen Windows - Apps / Software',
      },
  ...
  search: {
    ...
    fields: {
      ...
      size: { selector: 'td:nth-child(7) center' },
      seeders: { selector: 'td:nth-child(8) a' },
      leechers: { selector: 'td:nth-child(9) a' },
      grabs: { selector: 'td:nth-child(10) a', optional: true },
      date: {
