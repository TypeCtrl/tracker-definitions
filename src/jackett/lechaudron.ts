  ...
  caps: {
    categorymappings: [
      ...
      },
      {
        id: '32',
        cat: 'TV/Documentary',
        desc: 'Documentaires - Film Documentaire',
      },
      {
        id: '33',
        cat: 'TV/Documentary',
        desc: 'Documentaires - Spectacle',
      },
      ...
      { id: '59', cat: 'Movies/WEB-DL', desc: 'Films - WEB-DL' },
      { id: '60', cat: 'Movies/WEB-DL', desc: 'Films - WEB-DL 1080p' },
      { id: '61', cat: 'Movies/WEB-DL', desc: 'Films - WEB-DL 720p' },
      { id: '62', cat: 'Movies/WEB-DL', desc: 'Films - WEBRIP' },
      { id: '64', cat: 'Console/3DS', desc: 'Jeux - 3DS-DS' },
      { id: '65', cat: 'PC/Mobile-iOS', desc: 'Jeux - IOS-OSX' },
  ...
  search: {
    ...
    fields: {
      ...
      downloadvolumefactor: {
        case: { 'img[src$="/images/Torrents/freeleech.png"]': 0, '*': 1 },
      },
