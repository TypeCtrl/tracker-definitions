...
export const definition: TrackerDefinition = {
  ...
  download: {
    ...
    filters: [{ name: 'querystring', args: 'url' }, { name: 'replace', args: ['%E2%AD%90', ''] }],
  },
  search: {
    paths: [
      { path: 'torrents', inputs: { Torrent_page: '0' } },
      { path: 'torrents', inputs: { Torrent_page: '40' } },
      { path: 'torrents', inputs: { Torrent_page: '80' } },
    ],
    inputs: {
      ihq: '{{ .Keywords }}',
      iht: '{{ .Config.category }}',
