    ...
    categorymappings: [
      {
        id: '11',
        cat: 'Movies',
        desc: 'Movies Αποκλειστικά του HTz (HTz only)',
      },
      {
        id: '54',
        cat: 'Movies/BluRay',
        desc: 'Movies Blu-Ray 720p-1080p',
      },
      ...
      { id: '233', cat: 'Movies/DVD', desc: 'Movies DvdRip Full' },
      {
        id: '213',
        cat: 'Movies',
        desc: 'Movies Ελληνικές Ταινιίες (Greek)',
      },
      ...
      { id: '240', cat: 'PC/Mobile-Other', desc: 'Android - Linux' },
      {
        id: '230',
        cat: 'TV/Anime',
        desc: 'Παιδικα μεταγλωτισμε (Children)',
      },
      {
        id: '231',
        cat: 'TV/Anime',
        desc: 'Παιδικα υποτιτλους (Children w/ subs)',
      },
      ...
      { id: '227', cat: 'PC', desc: 'Pc Software' },
      {
        id: '225',
        cat: 'TV/Documentary',
        desc: 'Ντοκιμαντερ (Documentaries)',
      },
