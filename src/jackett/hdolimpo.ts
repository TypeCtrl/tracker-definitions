    ...
    fields: {
      ...
      title: {
        ...
        filters: [
          ...
          { name: 're_replace', args: ['[ -](?i)spa[ -]', ' SPANiSH '] },
          { name: 're_replace', args: ['[ -](?i)esp[ -]', ' SPANiSH '] },
          {
            name: 're_replace',
            args: ['[ -](?i)ingl[eé]s[ -]', ' English '],
          },
          { name: 're_replace', args: ['[ -](?i)[ei]ng[ -]', ' English '] },
          { name: 're_replace', args: ['[ -](?i)cat[ -]', ' Catalan '] },
          { name: 're_replace', args: ['[ -](?i)vas[ -]', ' Basque '] },
          { name: 're_replace', args: ['[ -](?i)fr[ae][ -]', ' French '] },
          { name: 're_replace', args: ['[ -](?i)jap[ -]', ' Japanese '] },
          { name: 're_replace', args: ['[ -](?i)ita[ -]', ' Italian '] },
          { name: 're_replace', args: ['[ -](?i)rus[ -]', ' Russian '] },
          { name: 're_replace', args: ['[ -](?i)ger[ -]', ' German '] },
          {
            name: 're_replace',
      ...
      downloadvolumefactor: {
        case: {
          ...
          'i[class*="fas fa-star text-gold"]': 0,
          'i[class*="fal fa-star text-gold"]': 0.5,
