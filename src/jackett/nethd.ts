  ...
  search: {
    ...
    fields: {
      ...
      date: {
        ...
        optional: true,
        filters: [
          { name: 're_replace', args: ['year|years', 'years '] },
          { name: 're_replace', args: ['month|months', 'months '] },
          { name: 're_replace', args: ['week|weeks', 'weeks '] },
          { name: 're_replace', args: ['day|days', 'days '] },
          { name: 're_replace', args: ['second|seconds', 'seconds '] },
          { name: 're_replace', args: ['minute|minutes', 'minutes '] },
          { name: 're_replace', args: ['hour|hours', 'hours '] },
          { name: 'timeago' },
        ],
      },
