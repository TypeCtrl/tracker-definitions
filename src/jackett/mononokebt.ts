...
export const definition: TrackerDefinition = {
  ...
  legacylinks: ['https://mononoke-bt.org/'],
  caps: {
  ...
  settings: [
    ...
    },
    {
      ...
      default:
        'Avant de pouvoir télécharger un torrent depuis Jackett, allez dans la <a href="https://mononoke-bt.org/faq.php" target="_blank">FAQ</a> et cliquer tous les \'Lu et Approuvé\' de la page.',
    },
    {
      name: 'IMPORTANT_EN',
      type: 'info',
      ...
      default:
        'Before you can even begin to download anything you need to go to the <a href="https://mononoke-bt.org/faq.php" target="_blank">FAQ</a> and click every \'Lu et Approuvé\' present on the page.',
    },
  ],
  login: {
    method: 'cookie',
  ...
  download: {
    before: {
      path: 'gettorrent.php',
      method: 'get',
      inputs: { id: '{{ .DownloadUri.Query.id }}' },
    },
  },
  search: {
    ...
    fields: {
      category: { text: 1 },
      title_normal: { selector: 'a[href^="details.php?id="]' },
      title_vostfr: { text: '{{ .Result.title_normal }} VOSTFR' },
      title: {
